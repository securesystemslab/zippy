...
class TestProgram(object):
    ...
    def _do_discovery(self, argv, Loader=loaderzippy.TestLoader):
        ...
        loader = Loader()
        self.test = loaderzippy.discover(start_dir, pattern, top_level_dir)

    def runTests(self):
        #if self.catchbreak:
        #    installHandler()
        if self.testRunner is None:
            self.testRunner = runnerzippy.TextTestRunner
