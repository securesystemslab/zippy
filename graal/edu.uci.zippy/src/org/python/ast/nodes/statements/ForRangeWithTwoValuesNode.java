...
public class ForRangeWithTwoValuesNode extends StatementNode {
    ...
    public ForRangeWithTwoValuesNode(LeftHandSideNode target, TypedNode start, TypedNode stop, BlockNode body, BlockNode orelse) {
    ...
    public void executeVoid(VirtualFrame frame) {        
        ...
        int start = (int) this.start.executeGeneric(frame);
