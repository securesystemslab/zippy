...
public class PyWriter extends PyObject {
    ...
    public static PyString __doc__writerows = Py
            .newString("writerows(sequence of sequences)\n"
                    + "\n"
    ...
    public static PyString __doc__writerow = Py
            .newString("writerow(sequence)\n"
                    + "\n"
     ...
     * copy_phase is false, then the method determines the new record length. If
     * copy_phase is true then the new field is appended to the record.
     */
    private int join_append_data(String field, boolean quote_empty,
            boolean copy_phase) {
        int i;
        ...
        // parsing below is based on _csv.c which expects all strings to be
        // terminated
        // with a nul byte.
        field += '\0';
        ...
        if (quoted) {
            if (copy_phase) {
                ...
                // Didn't know about leading quote until we found it necessary
                // in field
