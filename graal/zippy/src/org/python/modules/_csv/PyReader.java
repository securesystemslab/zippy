...
public class PyReader extends PyIterator {
    ...
    public PyString __doc__ = Py
            .newString("CSV reader\n"
                    + "\n"
    ...
    private void parse_process_char(char c) {
        ...
        case START_FIELD:
            ...
            if (c == '\n' || c == '\r' || c == '\0') {
                ...
                parse_save_field();
                state = c == '\0' ? ParserState.START_RECORD
                        : ParserState.EAT_CRNL;
            } else if (c == dialect.quotechar
                    && dialect.quoting != QuoteStyle.QUOTE_NONE) {
                // start quoted field
    ...
    private void parse_add_char(char c) {
        ...
        if (field_len >= _csv.field_limit) {
            throw _csv.Error(String.format(
                    "field larger than field limit (%d)", _csv.field_limit));
        }
        field.append(c);
    }
    ...
    private enum ParserState {
        START_RECORD, START_FIELD, ESCAPED_CHAR, IN_FIELD, IN_QUOTED_FIELD, ESCAPE_IN_QUOTED_FIELD, QUOTE_IN_QUOTED_FIELD, EAT_CRNL;
    }
}
