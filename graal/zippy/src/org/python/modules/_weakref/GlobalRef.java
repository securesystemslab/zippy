...
public class GlobalRef extends WeakReference {
    ...
    /**
     * The public hashCode for the Python AbstractReference wrapper. Derived
     * from the referent's hashCode.
     */
    ...
    private static ConcurrentMap<GlobalRef, GlobalRef> objects = Generic
            .concurrentMap();
    ...
    /**
     * Search for a reusable refrence. To be reused, it must be of the same
     * class and it must not have a callback.
     */
    ...
    public boolean equals(Object o) {
        ...
        // Don't consult the objects' equals (__eq__) method, it can't be
        // trusted
        return false;
    }
