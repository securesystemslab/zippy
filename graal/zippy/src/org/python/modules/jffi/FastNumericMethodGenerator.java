...
final class FastNumericMethodGenerator extends AbstractNumericMethodGenerator {
    ...
    private static final String[] methodNames = { "invokeVrN", "invokeNrN",
            "invokeNNrN", "invokeNNNrN", "invokeNNNNrN", "invokeNNNNNrN",
            "invokeNNNNNNrN" };
    ...
    String getInvokerMethodName(JITSignature signature) {
        ...
        if (parameterCount <= MAX_PARAMETERS
            ...
            throw new IllegalArgumentException(
                    "invalid fast-long parameter count: " + parameterCount);
        }
    }
    ...
    final static int getMaximumFastNumericParameters() {
        try {
            com.kenai.jffi.Invoker.class.getDeclaredMethod("invokeNNNNNNrN",
                    com.kenai.jffi.Function.class, long.class, long.class,
