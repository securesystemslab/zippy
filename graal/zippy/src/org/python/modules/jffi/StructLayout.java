...
public class StructLayout extends CType.Custom {
    ...
    private static final class StructUtil {
        ...
        public static final StructLayout newStructLayout(Field[] fields,
                boolean isUnion) {
            ...
            com.kenai.jffi.Type jffiType = isUnion ? new com.kenai.jffi.Union(
                    fieldTypes) : new com.kenai.jffi.Struct(fieldTypes);
    ...
    @ExposedNew
    public static PyObject StructLayout_new(PyNewWrapper new_, boolean init,
            PyType subtype, PyObject[] args, String[] keywords) {

        ArgParser ap = new ArgParser("__init__", args, keywords, new String[] {
                "fields", "union" }, 1);
        ...
        for (int i = 0; i < fields.length; ++i) {
            ...
            if (!(pyField instanceof Field)) {
                throw Py.TypeError(String
                        .format("element %d of field list is not an instance of jffi.StructLayout.Field",
                                i));
            }
        ...
        return StructUtil.newStructLayout(fields, ap.getPyObject(1, Py.False)
                .__nonzero__());
    }
    ...
    public static class ScalarField extends Field {
        ...
        @ExposedNew
        public static PyObject ScalarField_new(PyNewWrapper new_, boolean init,
                PyType subtype, PyObject[] args, String[] keywords) {
            ArgParser ap = new ArgParser("__init__", args, keywords,
                    new String[] { "name", "type", "offset" });

            return new ScalarField(ap.getPyObject(0), CType.typeOf(ap
                    .getPyObject(1)), ap.getInt(2));
        }
    }
