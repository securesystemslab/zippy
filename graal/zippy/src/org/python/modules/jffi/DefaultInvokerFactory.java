...
class DefaultInvokerFactory {
    ...
    final Invoker createInvoker(com.kenai.jffi.Function function,
            PyObject returnType, PyObject[] parameterTypes) {
    ...
    final Invoker createInvoker(com.kenai.jffi.Function function,
            CType[] parameterTypes, CType returnType) {
        ParameterMarshaller[] marshallers = new ParameterMarshaller[parameterTypes.length];
    ...
    final Invoker createInvoker(com.kenai.jffi.Function function,
            NativeType[] parameterTypes, NativeType returnType) {
        ParameterMarshaller[] marshallers = new ParameterMarshaller[parameterTypes.length];
    ...
    final Invoker createInvoker(com.kenai.jffi.Function function,
            PyObject returnType, ParameterMarshaller[] marshallers) {
        CType cReturnType = CType.typeOf(returnType);
        if (cReturnType instanceof CType.Builtin) {
            return createInvoker(function, cReturnType.getNativeType(),
                    marshallers);
        }
    ...
    final Invoker createInvoker(com.kenai.jffi.Function function,
            NativeType returnType, ParameterMarshaller[] marshallers) {
        switch (returnType) {
        case VOID:
        ...
        case LONG:
            return Platform.getPlatform().longSize() == 32 ? new Signed32Invoker(
                    function, marshallers) : new Signed64Invoker(function,
                    marshallers);

        case ULONG:
            return Platform.getPlatform().longSize() == 32 ? new Unsigned32Invoker(
                    function, marshallers) : new Unsigned64Invoker(function,
                    marshallers);
        case FLOAT:
    ...
    static final ParameterMarshaller getMarshaller(NativeType type) {
        ...
        case LONG:
            return Platform.getPlatform().longSize() == 32 ? Signed32Marshaller.INSTANCE
                    : Signed64Marshaller.INSTANCE;
        case ULONG:
            return Platform.getPlatform().longSize() == 32 ? Unsigned32Marshaller.INSTANCE
    ...
    private static abstract class BaseInvoker extends Invoker {
        ...
        final com.kenai.jffi.Invoker jffiInvoker = com.kenai.jffi.Invoker
                .getInstance();
        ...
        public final PyObject invoke(PyObject arg0, PyObject arg1,
                PyObject arg2, PyObject arg3, PyObject arg4, PyObject arg5) {
        ...
        final void checkArity(int got) {
            if (got != arity) {
                throw Py.TypeError(String.format("expected %d args; got %d",
                        arity, got));
            }
        }
    }
    ...
    private static final class Signed8Invoker extends BaseInvoker {
        ...
        public Signed8Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return Util.newSigned8(jffiInvoker.invokeInt(jffiFunction,
    ...
    private static final class Unsigned8Invoker extends BaseInvoker {
        ...
        public Unsigned8Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return Util.newUnsigned8(jffiInvoker.invokeInt(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class Signed16Invoker extends BaseInvoker {
        ...
        public Signed16Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return JITRuntime.newSigned16(jffiInvoker.invokeInt(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class Unsigned16Invoker extends BaseInvoker {
        ...
        public Unsigned16Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return JITRuntime.newUnsigned16(jffiInvoker.invokeInt(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class Signed32Invoker extends BaseInvoker {
        ...
        public Signed32Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return JITRuntime.newSigned32(jffiInvoker.invokeInt(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class Unsigned32Invoker extends BaseInvoker {
        ...
        public Unsigned32Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return JITRuntime.newUnsigned32(jffiInvoker.invokeInt(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class Signed64Invoker extends BaseInvoker {
        ...
        public Signed64Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return JITRuntime.newSigned64(jffiInvoker.invokeLong(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class Unsigned64Invoker extends BaseInvoker {
        ...
        public Unsigned64Invoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return JITRuntime.newUnsigned64(jffiInvoker.invokeLong(
                    jffiFunction, convertArguments(args)));
        }
    }
    ...
    private static final class FloatInvoker extends BaseInvoker {
        ...
        public final PyObject invoke(PyObject[] args) {
            return Py.newFloat(jffiInvoker.invokeFloat(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class DoubleInvoker extends BaseInvoker {
        ...
        public DoubleInvoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return Py.newFloat(jffiInvoker.invokeDouble(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static final class PointerInvoker extends BaseInvoker {
        ...
        public PointerInvoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return Py.newLong(jffiInvoker.invokeAddress(jffiFunction,
                    convertArguments(args)));
        }
    }

    private static final class StringInvoker extends BaseInvoker {
        private static final com.kenai.jffi.MemoryIO IO = com.kenai.jffi.MemoryIO
                .getInstance();

        public StringInvoker(Function function,
                ParameterMarshaller[] marshallers) {
            super(function, marshallers);
        }

        public final PyObject invoke(PyObject[] args) {
            return JITRuntime.newString(jffiInvoker.invokeAddress(jffiFunction,
                    convertArguments(args)));
        }
    }
    ...
    private static class StringMarshaller extends BaseMarshaller {
        ...
        public void marshal(HeapInvocationBuffer buffer, PyObject parameter) {
            if (parameter instanceof StringCData) {
                buffer.putAddress(((StringCData) parameter).getMemory()
                        .getAddress());
            } else if (parameter instanceof PyNone) {
                buffer.putAddress(0);
            } else {
                byte[] bytes = parameter.toString().getBytes();
                buffer.putArray(bytes, 0, bytes.length, ArrayFlags.IN
                        | ArrayFlags.NULTERMINATE);
            }
        }
    }
    ...
    private static class PointerMarshaller extends BaseMarshaller {
        ...
        public void marshal(HeapInvocationBuffer buffer, PyObject parameter) {
            if (parameter instanceof Pointer) {
                buffer.putAddress(((Pointer) parameter).getMemory()
                        .getAddress());
