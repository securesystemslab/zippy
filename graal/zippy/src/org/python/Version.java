...
public class Version {
    ...
    private static void loadProperties() {
        ...
        if (in != null) {
            try {
                ...
                PY_MAJOR_VERSION = Integer.valueOf(properties
                        .getProperty("jython.major_version"));
                PY_MINOR_VERSION = Integer.valueOf(properties
                        .getProperty("jython.minor_version"));
                PY_MICRO_VERSION = Integer.valueOf(properties
                        .getProperty("jython.micro_version"));
                PY_RELEASE_LEVEL = Integer.valueOf(properties
                        .getProperty("jython.release_level"));
                PY_RELEASE_SERIAL = Integer.valueOf(properties
                        .getProperty("jython.release_serial"));
                ...
                System.err.println("There was a problem loading ".concat(
                        versionProperties).concat(":"));
                ioe.printStackTrace();
            } finally {
                try {
                    in.close();
        ...
        if (!loaded) {
            ...
            throw new RuntimeException(
                    "unable to load ".concat(versionProperties));
        }
    }

    /**
     * Return the current hg version number. May be an empty string on
     * environments that can't determine it.
     */
    ...
    public static String getBuildInfo() {
        ...
        return String.format("%s%s%s, %.20s, %.9s", hgId, sep, revision, DATE,
                TIME);
    }
    ...
    /**
     * Return the Python version, including compiler (or in our case, the Java
     * VM).
     */
    public static String getVersion() {
        return String.format("%.80s (%.80s) %.80s", PY_VERSION, getBuildInfo(),
                getVM());
    }
