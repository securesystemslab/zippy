...
public class NModule extends NNode {
    ...
    public NType resolve(Scope s) throws Exception {
        ...
        if (mb == null) {
            Indexer.idx.reportFailedAssertion("No module for " + name + ": "
                    + file);
    ...
    /**
     * If the module defines an {@code __all__} variable, resolve references to
     ...
     *         {@code __all__ = [name for name in dir() if name[0] == "e"]} are
     *         valid provided the expr result is a string list.
     */
