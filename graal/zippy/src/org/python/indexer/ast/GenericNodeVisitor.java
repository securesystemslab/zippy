...
/**
 * A visitor that passes every visited node to a single function. Subclasses
 * need only implement {@link #dispatch} to receive every node as a generic
 * {@link NNode}.
 */
public abstract class GenericNodeVisitor extends DefaultNodeVisitor {

    /**
     * Every visited node is passed to this method. The semantics for halting
     * traversal are the same as for {@link DefaultNodeVisitor}.
     * 
