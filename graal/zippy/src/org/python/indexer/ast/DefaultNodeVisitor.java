...
/**
 * A visitor that by default visits every node in the tree. Subclasses can
 * override specific node visiting methods and decide whether to visit the
 * children.
 */
public class DefaultNodeVisitor implements NNodeVisitor {
     ...
     * <p>
     * 
     * If the traversal should be halted immediately without visiting any
     * further nodes, the visitor can throw a {@link StopIterationException}.
     */
