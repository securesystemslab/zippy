...
/**
 * Represents an instance of a class. Currently there is nothing in the indexer
 * that needs to distinguish instances from classes -- both classes and their
 * instances are merged into a single type.
 */
