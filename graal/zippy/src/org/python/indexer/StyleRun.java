...
public class StyleRun implements Comparable<StyleRun> {
    ...
    public enum Type {
        KEYWORD, COMMENT, STRING, DOC_STRING, IDENTIFIER, BUILTIN, NUMBER, CONSTANT, // ALL_CAPS
                                                                                     // identifier
        ...
        LINK, // hyperlink
        ANCHOR, // name anchor
        DELIMITER, TYPE_NAME, // reference to a type (e.g. function or class
                              // name)
        // diagnostics
        ERROR, WARNING, INFO
    }
    ...
    public boolean equals(Object o) {
        ...
        return other.type == this.type && other.offset == this.offset
