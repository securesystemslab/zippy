 ...
 * with its own bindings. We adapt this multi-scope object for use as both a
 * local and global dictionary.
 */
...
public final class PyScriptEngineScope extends PyObject {
    public static final PyType TYPE = PyType
            .fromClass(PyScriptEngineScope.class);
    ...
    final PyObject scope_get(PyObject keyObj, PyObject defaultObj) {
        ...
        return scope == -1 ? defaultObj : Py.java2py(context.getAttribute(key,
                scope));
    }
    ...
    final PyObject scope_setdefault(PyObject keyObj, PyObject failObj) {
        ...
        if (scope == -1) {
            ...
            context.setAttribute(key, failObj instanceof PyType ? failObj
                    : failObj.__tojava__(Object.class), scope);
            result = failObj;
        } else {
    ...
    public void __setitem__(String key, PyObject value) {
        ...
        context.setAttribute(
                key,
                value instanceof PyType ? value : value
                        .__tojava__(Object.class), scope);
    }
