...
public class BaseParser {
    ...
    protected TruffleParser setupTruffleParser(boolean single) {
    ...
    public mod parseInteractive() {
        ...
        try {
            ...
            // I am only throwing ParseExceptions, but
            // "throws RecognitionException" still gets
            // into the generated code.
            System.err
                    .println("FIXME: pretty sure this can't happen -- but needs to be checked");
        }
        return tree;
    }
    ...
    public mod parseModule() {
        ...
        if (Options.interpretAST) {
            TruffleParser parser = setupTruffleParser(false);
            try {
                TruffleParser.file_input_return r = parser.file_input();
                tree = (mod) r.tree;
            } catch (RecognitionException e) {
                // XXX: this can't happen. Need to strip the throws from antlr
                // generated code.
