...
public class Slice extends slice {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("lower"), new PyString("upper"), new PyString("step") };
    ...
    public Object executeGeneric(VirtualFrame frame) {
        PyObject start = (PyObject) (lower == null ? null : lower.executeGeneric(frame));
        PyObject stop = (PyObject) (upper == null ? null : upper.executeGeneric(frame));
        PyObject stp = (PyObject) (step == null ? null : step.executeGeneric(frame));
        return new PySlice(start, stop, stp);
    }
