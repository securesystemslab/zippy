...
public class Module extends mod {
    ...
    private final static PyString[] fields = new PyString[] { new PyString(
            "body") };
    ...
    public void Module___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("Module", args, keywords,
                new String[] { "body" }, 1, true);
        ...
        if (Options.specialize) {
            for (int i = 0; i < body.size(); i++) {
                ...
                if (s instanceof stmt) {
                    ...
                    throw new RuntimeException("unexpected statement type " + s.getClass().getSimpleName());
                }
            }
        } else {
            for (stmt s : body) {
