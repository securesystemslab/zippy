...
public class AstModule implements ClassDictInit {
    ...
    public static void classDictInit(PyObject dict) {
        ...
        dict.__setitem__("PyCF_ONLY_AST", new PyInteger(
        ...
        dict.__setitem__("operator",
                imp.importName("org.python.antlr.ast.operatorType", false));
        ...
        dict.__setitem__("boolop",
                imp.importName("org.python.antlr.ast.boolopType", false));
        dict.__setitem__("And", And.TYPE);
        dict.__setitem__("Or", Or.TYPE);

        dict.__setitem__("cmpop",
                imp.importName("org.python.antlr.ast.cmpopType", false));
        ...
        dict.__setitem__("expr_context",
                imp.importName("org.python.antlr.ast.expr_contextType", false));
        ...
        dict.__setitem__("unaryop",
                imp.importName("org.python.antlr.ast.unaryopType", false));
