...
public class Attribute extends expr implements Context {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("value"), new PyString("attr"), new PyString("ctx") };
    ...
    public Attribute(Integer ttype, Token token, expr value, Name attr,
    ...
    public Attribute(Integer ttype, Token token, expr value, String attr,
            expr_contextType ctx) {
        super(ttype, token);
        this.value = value;
        addChild(value);
    ...
    public Attribute(PythonTree tree, expr value, String attr,
            expr_contextType ctx) {
        super(tree);
        this.value = value;
        addChild(value);
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        if (ctx == expr_contextType.Load) {
            return val.__findattr__(attr);
        } else {
            Py.SystemError("Attribute with non-Load context is not implemented");
        }
