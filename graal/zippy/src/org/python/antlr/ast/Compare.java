...
public class Compare extends expr {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("left"), new PyString("ops"),
            new PyString("comparators") };
    ...
    public Compare(Token token, expr left, java.util.List<cmpopType> ops,
    ...
    public Compare(Integer ttype, Token token, expr left,
            java.util.List<cmpopType> ops, java.util.List<expr> comparators) {
        super(ttype, token);
        this.left = left;
        addChild(left);
        this.ops = ops;
    ...
    public Compare(PythonTree tree, expr left, java.util.List<cmpopType> ops,
            java.util.List<expr> comparators) {
        super(tree);
        this.left = left;
        addChild(left);
    ...
    public Object executeGeneric(VirtualFrame frame) {
        PyObject leftValue = (PyObject) left.executeGeneric(frame);
        PyObject rightValue = null;
        Iterator<cmpopType> operators = ops.iterator();
        PyObject ret = Py.True;

        for (expr e : comparators) {
            rightValue = (PyObject) e.executeGeneric(frame);
            cmpopType op = operators.next();
            PyObject temp;

            switch (op) {
            case Eq:
                temp = leftValue._eq(rightValue);
                ret = ret.__and__(temp);
                break;
            case NotEq:
                temp = leftValue._ne(rightValue);
                ret = ret.__and__(temp);
                break;
            case Lt:
                temp = leftValue._lt(rightValue);
                ret = ret.__and__(temp);
                break;
            case LtE:
                temp = leftValue._le(rightValue);
                ret = ret.__and__(temp);
                break;
            case Gt:
                temp = leftValue._gt(rightValue);
                ret = ret.__and__(temp);
                break;
            case GtE:
                temp = leftValue._ge(rightValue);
                ret = ret.__and__(temp);
                break;
            case Is:
                temp = leftValue._is(rightValue);
                ret = ret.__and__(temp);
                break;
            case IsNot:
                temp = leftValue._isnot(rightValue);
                ret = ret.__and__(temp);
                break;
            case In:
                temp = leftValue._in(rightValue);
                ret = ret.__and__(temp);
                break;
            case NotIn:
                temp = leftValue._notin(rightValue);
                ret = ret.__and__(temp);
                break;
            default:
                throw Py.SystemError("Not known operator!");
            }
