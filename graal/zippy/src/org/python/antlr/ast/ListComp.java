...
public class ListComp extends expr {
    ...
    public ListComp(Token token, expr elt,
    ...
    public ListComp(Integer ttype, Token token, expr elt,
            java.util.List<comprehension> generators) {
        super(ttype, token);
        this.elt = elt;
        addChild(elt);
    ...
    public ListComp(PythonTree tree, expr elt,
            java.util.List<comprehension> generators) {
        super(tree);
        this.elt = elt;
        addChild(elt);
    ...
    public Object executeGeneric(VirtualFrame frame) {
        Object list = generators.get(0).execute(frame);
        frame.setObject(slot, list);
        return list;
    }
