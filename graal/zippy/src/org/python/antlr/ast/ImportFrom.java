...
public class ImportFrom extends stmt {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("module"), new PyString("names"),
            new PyString("level") };
    ...
    public void ImportFrom___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("ImportFrom", args, keywords,
                new String[] { "module", "names", "level", "lineno",
                        "col_offset" }, 3, true);
    ...
    public ImportFrom(Token token, String module, List<Name> moduleNames,
    ...
    public ImportFrom(PythonTree tree, String module, List<alias> names,
            Integer level) {
        super(tree);
        this.module = module;
        this.names = names;
    ...
    public void executeVoid(VirtualFrame frame) {
        PyObject importedModule = __builtin__.__import__(module);
        
        for (alias aliasName : names) {
            String name = aliasName.getInternalName();
            PyObject importee = null;
            try {
                importee = importedModule.__getattr__(name);
            ...
            frame.setObject(aliasName.getSlot(), importee);
        }
    }
