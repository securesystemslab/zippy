...
public class BinOp extends expr {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("left"), new PyString("op"), new PyString("right") };
    ...
    public BinOp(Integer ttype, Token token, expr left, operatorType op,
            expr right) {
        super(ttype, token);
        this.left = left;
        addChild(left);
    ...
    public Object executeGeneric(VirtualFrame frame) {    	
		...
		PyObject rightValue = (PyObject) right.executeGeneric(frame);
		PyObject result = null;

    	switch(op) {
    		case Add:
    			result = leftValue._add(rightValue);
    			break;
    		case Sub:
    			result = leftValue._sub(rightValue);
    			break;
    		case Mult:
    			result = leftValue._mul(rightValue);
    			break;
    		case Div:
    			result = leftValue._div(rightValue);
    			break;    		
    		case Mod:
    			result = leftValue._mod(rightValue);
    			break;
    		case Pow:
    			result = leftValue._pow(rightValue);
    			break;
    		case LShift:
    			result = leftValue._lshift(rightValue);
    			break;
    		case RShift:
    			result = leftValue._rshift(rightValue);
    			break;
    		case BitOr:
    			result = leftValue._or(rightValue);
    			break;
    		case BitXor:
    			result = leftValue._xor(rightValue);
    			break;
    		case BitAnd:
    			result = leftValue._and(rightValue);
    			break;
    		case FloorDiv:
    			result = leftValue._floordiv(rightValue);
    			break;    			
    		default:
