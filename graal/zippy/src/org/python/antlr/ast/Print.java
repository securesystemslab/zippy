...
public class Print extends stmt {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("dest"), new PyString("values"), new PyString("nl") };
    ...
    public Print(Integer ttype, Token token, expr dest,
            java.util.List<expr> values, Boolean nl) {
        super(ttype, token);
        this.dest = dest;
        addChild(dest);
        this.values = values;
    ...
    public Print(PythonTree tree, expr dest, java.util.List<expr> values,
            Boolean nl) {
        super(tree);
        this.dest = dest;
        addChild(dest);
...
//            for (PythonTree t : values) {
            // Truffle: due to ConcurrentModificationException
    ...
    public StringBuilder getOutStream() {
        return out;
    }
