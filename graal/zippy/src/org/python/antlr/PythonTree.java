...
//    private PythonTree parent;
    ...
    /**
     * Converts a list of Name to a dotted-name string. Because leading dots are
     * indexable identifiers (referring to parent directories in relative
     * imports), a Name list may include leading dots, but not dots between
     * names.
     */
    ...
    public String toString() {
        ...
        return node.getToken().getText() + "(" + this.getLine() + ","
    ...
    /**
     * Get the children internal List; note that if you directly mess with the
     * list, do so at your own risk.
     */
    // Truffle see truffle.api.nodes.Node
...
//    }
     ...
     * routine moves children to t via t.children = child.children; i.e.,
        ...
        if (childTree.isNil()) { // t is an empty node possibly with children
            if (this.children != null && this.children == childTree.children) {
                throw new RuntimeException(
                        "attempt to add child list to itself");
            }
    ...
    public void setChild(int i, PythonTree t) {
        ...
        if (t.isNil()) {
            throw new IllegalArgumentException(
                    "Can't set single child to a list");
        }
        if (children == null) {
    ...
    public void replaceChildren(int startChildIndex, int stopChildIndex,
        ...
        if (delta == 0) {
            ...
            freshenParentAndChildIndexes(startChildIndex);
                 ...
                 // fill in as many children as we can (replacingHowMany) w/o
                 // moving data
