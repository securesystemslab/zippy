...
class ReflectedCallData {
    ...
    /**
     * errArg value if the self passed to a call wasn't compatible with the type
     * of the method.
     */
    ...
    /**
     * Either {@link #BAD_ARG_COUNT}, {@link #UNABLE_TO_CONVERT_SELF}, or the
     * index of the unconvertible argument in args.
     */
