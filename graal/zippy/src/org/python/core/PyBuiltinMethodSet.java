...
public class PyBuiltinMethodSet extends PyBuiltinFunctionSet implements
    ...
    public PyBuiltinMethodSet(String name, int index, int minargs, int maxargs,
            String doc, Class<?> type) {
        ...
        if (obj != null) {
            if (this.type.isAssignableFrom(obj.getClass())) {
                ...
                throw Py.TypeError(String.format(
                        "descriptor '%s' for '%s' objects doesn't apply "
    ...
    public PyBuiltinCallable bind(PyObject bindTo) {
        ...
        bindable = (PyBuiltinMethodSet) copy();
