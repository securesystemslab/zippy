...
public class PyComplex extends PyObject {
    ...
    @ExposedNew
    public static PyObject complex_new(PyNewWrapper new_, boolean init,
        ...
        if (new_.for_type != subtype) {
            complexReal = new PyComplexDerived(subtype, complexReal.real,
                    complexReal.imag);
        }
        return complexReal;
    }
    ...
    final String complex_toString() {
        if (real == 0.) {
            ...
            if (imag >= 0) {
                return String
                        .format("(%s+%sj)", toString(real), toString(imag));
            } else {
                return String.format("(%s-%sj)", toString(real),
                        toString(-imag));
            }
        }
    }
    ...
    private final boolean canCoerce(PyObject other) {
        return other instanceof PyComplex || other instanceof PyFloat
                || other instanceof PyInteger || other instanceof PyLong;
    }
    ...
    private final static PyObject _mul(PyComplex o1, PyComplex o2) {
        return new PyComplex(o1.real * o2.real - o1.imag * o2.imag, o1.real
                * o2.imag + o1.imag * o2.real);
    }
    ...
    private final static PyObject _div(PyComplex a, PyComplex b) {
        ...
        if (abs_breal >= abs_bimag) {
            ...
            return new PyComplex((a.real * ratio + a.imag) / denom, (a.imag
                    * ratio - a.real)
                    / denom);
        }
    }
    ...
    // Special case __tojava__ for bug 1605, since we broke it with our support
    // for faux floats.
        ...
        try {
            ...
            default:
                ...
                throw Py.ValueError(String
                        .format("Unknown format code '%c' for object of type 'complex'",
                                spec.type));
            }
