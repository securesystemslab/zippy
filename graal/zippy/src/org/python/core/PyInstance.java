...
public class PyInstance extends PyObject {
    ...
    @ExposedNew
    public static PyObject instance___new__(PyNewWrapper new_, boolean init,
            PyType subtype, PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("instance", args, keywords, "name",
                "bases", "dict");
    ...
    public Object __tojava__(Class c) {
        ...
        if (instclass.__tojava__ != null) {
            // try {
            PyObject ret = instclass.__tojava__.__call__(this,
                    PyType.fromClass(c));
    ...
    public boolean isNumberType() {
        return __findattr__("__int__") != null
                || __findattr__("__float__") != null;
    }
    ...
    public void noAttributeError(String name) {
        throw Py.AttributeError(String.format(
                "%.50s instance has no attribute '%.400s'", instclass.__name__,
                name));
    }
    ...
    /**
     * If a class doesn't define a __repr__ method of its own, the return value
     * from this method is used.
     */
    protected PyString makeDefaultRepr() {
        PyObject mod = instclass.__dict__.__finditem__("__module__");
        String modStr = (mod == null || !Py.isInstance(mod, PyString.TYPE)) ? "?"
                : mod.toString();
        return new PyString(String.format("<%s.%s instance at %s>", modStr,
                instclass.__name__, Py.idstr(this)));
    }
    ...
    @ExposedMethod
    final PyObject instance___getslice__(PyObject start, PyObject stop,
            PyObject step) {
        if (step != null) {
    ...
    @ExposedMethod
    final void instance___setslice__(PyObject start, PyObject stop,
            PyObject step, PyObject value) {
        if (step != null) {
    ...
    @ExposedMethod
    final void instance___delslice__(PyObject start, PyObject stop,
            PyObject step) {
        if (step != null) {
    ...
    /**
     * Implements the __index__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    final PyObject instance___index__() {
        ...
        throw Py.TypeError(String.format(
                "__index__ returned non-(int,long) (type %s)", ret.getType()
                        .fastGetName()));
    }
    ...
    /**
     * Implements the __hex__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __oct__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __int__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __float__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __long__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __complex__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __pos__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __neg__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __abs__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __invert__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod
    ...
    /**
     * Implements the __add__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    ...
    /**
     * Implements the __radd__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __iadd__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __sub__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rsub__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __isub__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __mul__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rmul__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __imul__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __div__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rdiv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __idiv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __floordiv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rfloordiv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __ifloordiv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __truediv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rtruediv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __itruediv__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __mod__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rmod__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __imod__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __divmod__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rdivmod__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __pow__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rpow__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __ipow__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __lshift__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rlshift__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __ilshift__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rshift__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rrshift__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __irshift__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __and__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rand__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __iand__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __or__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __ror__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __ior__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __xor__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __rxor__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
    ...
    /**
     * Implements the __ixor__ method by looking it up in the instance's
     * dictionary and calling it if it is found.
     **/
    @ExposedMethod(type = MethodType.BINARY)
