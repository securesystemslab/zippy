...
public class FileUtil {
    ...
    /**
     * Creates a PyFile that reads from the given <code>InputStream</code> with
     * mode.
     */
    public static PyFile wrap(InputStream is, String mode) {
        return new PyFile(is, "<Java InputStream '" + is + "' as file>", mode,
                -1, true);
    }
    ...
    /**
     * Creates a PyFile that writes to the given <code>OutputStream</code> with
     * bufsize.
     */
     ...
     * <p/>
     * Note that using this method to read very large streams could cause
     * out-of-memory exceptions and/or block for large periods of time.
     */
