...
public class PyFunction extends PyObject implements InvocationHandler {
    ...
    /**
     * Default argument values for associated kwargs. Exposed as a tuple to
     * Python. Writable.
     */
    ...
    /**
     * A function's lazily created __dict__; allows arbitrary attributes to be
     * tacked on. Read only.
     */
    ...
    public PyFunction(PyObject globals, PyObject[] defaults, PyCode code,
        ...
        func_defaults = (defaults != null && defaults.length == 0) ? null
                : defaults;
        __code__ = code;
        func_closure = closure_cells != null ? new PyTuple(closure_cells)
                : null;
    ...
    @ExposedNew
    static final PyObject function___new__(PyNewWrapper new_, boolean init,
            PyType subtype, PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("function", args, keywords, new String[] {
        ...
        if (nfree != nclosure) {
            throw Py.ValueError(String.format(
                    "%s requires closure of length %d, not %d", tcode.co_name,
                    nfree, nclosure));
        }
        if (nclosure > 0) {
            for (PyObject o : ((PyTuple) closure).asIterable()) {
                if (!(o instanceof PyCell)) {
                    throw Py.TypeError(String.format(
                            "arg 5 (closure) expected cell, found %s", o
                                    .getType().fastGetName()));
                }
            }
        }
        ...
        PyFunction function = new PyFunction(globals,
                ...
                tcode, null, closure == Py.None ? null
    ...
    public void setFuncDefaults(PyObject func_defaults) {
        ...
        this.func_defaults = func_defaults == Py.None ? null
                : ((PyTuple) func_defaults).getArray();
    }
    ...
    public PyObject __call__(ThreadState state, PyObject arg0) {
        return __code__.call(state, arg0, __globals__, func_defaults,
                func_closure);
    }
    ...
    public PyObject __call__(ThreadState state, PyObject arg0, PyObject arg1) {
        return __code__.call(state, arg0, arg1, __globals__, func_defaults,
                func_closure);
    }
    ...
    public PyObject __call__(ThreadState state, PyObject arg0, PyObject arg1,
            PyObject arg2) {
        return __code__.call(state, arg0, arg1, arg2, __globals__,
    ...
    public PyObject __call__(ThreadState state, PyObject arg0, PyObject arg1,
        ...
        return __code__.call(state, arg0, arg1, arg2, arg3, __globals__,
                func_defaults, func_closure);
    }
    ...
    final PyObject function___call__(ThreadState state, PyObject[] args,
            String[] keywords) {
        return __code__.call(state, args, keywords, __globals__, func_defaults,
                func_closure);
    }
    ...
    public PyObject __call__(ThreadState state, PyObject arg1, PyObject[] args,
            String[] keywords) {
        return __code__.call(state, arg1, args, keywords, __globals__,
                func_defaults, func_closure);
    }
    ...
    public Object __tojava__(Class<?> c) {
        ...
        if (c.isInstance(this) && c != InvocationHandler.class) {
            ...
            // InvocationHandler is special, since it's a single method
            // interface
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
            throws Throwable {
        // Handle invocation when invoked through Proxy (as coerced to single
        // method interface)
        if (method.getDeclaringClass() == Object.class) {
            ...
            return __call__(Py.javas2pys(args)).__tojava__(
