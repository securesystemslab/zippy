...
public class PyProperty extends PyObject {
    ...
    public void property___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("property", args, keywords, new String[] {
    ...
    /**
     * Return a copy of this property with the optional addition of a
     * get/set/del. Helper method for the getter/setter/deleter methods.
     */
