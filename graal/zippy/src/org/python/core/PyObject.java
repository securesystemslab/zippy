...
public class PyObject extends RootNode implements Serializable {
     ...
     * of. Anything attempting to use the proxy should go through
    ...
    static {
        ...
        if (Py.BOOTSTRAP_TYPES.size() > 0) {
            Py.writeWarning("init",
                    "Bootstrap types weren't encountered in bootstrapping: "
                            + Py.BOOTSTRAP_TYPES);
        }
    }
     ...
     * <code>objtype</code> field to correspond to the specific subclass of
     * <code>PyObject</code> being instantiated.
     **/
    public PyObject() {
    ...
    /**
     * Creates the PyObject for the base type. The argument only exists to make
     * the constructor distinct.
     */
    ...
    @ExposedNew
    static final PyObject object___new__(PyNewWrapper new_, boolean init,
            PyType subtype, PyObject[] args, String[] keywords) {
        // don't allow arguments if the default object.__init__() is about to be
        // called
        ...
        if (subtype.isAbstract()) {
            ...
            PyObject sorted = Py.getSystemState().getBuiltins()
                    .__getitem__(Py.newString("sorted"));
            PyString methods = Py.newString(", ").join(
                    sorted.__call__(subtype.getAbstractmethods()));
            throw Py.TypeError(String.format(
                    "Can't instantiate abstract class %s with abstract "
                            + "methods %s", subtype.fastGetName(), methods));
        }

        return new_.for_type == subtype ? new PyObject() : new PyObjectDerived(
                subtype);
    }
     ...
     * wasn't initialized by our __init__.
     */
    void proxyInit() {
    ...
    /**
     * Equivalent to the standard Python __repr__ method. This method should not
     * typically need to be overrriden. The easiest way to configure the string
     * representation of a <code>PyObject</code> is to override the standard
     * Java <code>toString</code> method.
     **/
    ...
    final String object_toString() {
        ...
        if (module instanceof PyString
                && !module.toString().equals("__builtin__")) {
            return String.format("<%s.%s object at %s>", module.toString(),
                    name, Py.idstr(this));
        }
    ...
    /**
     * Equivalent to the standard Python __hash__ method. This method can not be
     * overridden. Instead, you should override the standard Java
     * <code>hashCode</code> method to return an appropriate hash code for the
     * <code>PyObject</code>.
     **/
    ...
    /**
     * Should almost never be overridden. If overridden, it is the subclasses
     * responsibility to ensure that <code>a.equals(b) == true</code> iff
     * <code>cmp(a,b) == 0</code>
     **/
    @Override
    ...
    /**
     * Equivalent to the Jython __tojava__ method. Tries to coerce this object
     * to an instance of the requested Java class. Returns the special object
     * <code>Py.NoConversion</code> if this <code>PyObject</code> can not be
     * converted to the desired Java class.
     * 
     * @param c
    ...
    public Object __tojava__(Class<?> c) {
        ...
        // convert faux floats
        // XXX: should also convert faux ints, but that breaks
    ...
    public PyObject __call__(PyObject args[], String keywords[]) {
        throw Py.TypeError(String.format("'%s' object is not callable",
                getType().fastGetName()));
    }
    ...
    /**
     * A variant of the __call__ method with one extra initial argument. This
     * variant is used to allow method invocations to be performed efficiently.
     * 
     ...
     * @param args
     *            the last arguments to the function (including keyword
     *            arguments).
     * @param keywords
     *            the keywords used for all keyword arguments.
     **/
    ...
    /**
     * A variant of the __call__ method when no keywords are passed. The default
     * behavior is to invoke <code>__call__(args, keywords)</code> with the
     * appropriate arguments. The only reason to override this function would be
    ...
    /**
     * A variant of the __call__ method with no arguments. The default behavior
     * is to invoke <code>__call__(args, keywords)</code> with the appropriate
     * arguments. The only reason to override this function would be for
    ...
    /**
     * A variant of the __call__ method with one argument. The default behavior
     * is to invoke <code>__call__(args, keywords)</code> with the appropriate
     * arguments. The only reason to override this function would be for
     * improved performance.
     * 
    ...
    /**
     * A variant of the __call__ method with two arguments. The default behavior
     * is to invoke <code>__call__(args, keywords)</code> with the appropriate
     * arguments. The only reason to override this function would be for
     * improved performance.
     * 
    ...
    public PyObject _callextra(PyObject[] args, String[] keywords,
        ...
        if (starargs != null) {
            ...
            PyObject iter = Py.iter(starargs, name
        ...
        System.arraycopy(args, args.length - keywords.length, newargs, argidx,
                keywords.length);
        ...
        if (kwargs != null) {
            ...
            for (int i = 0; (key = keys.__finditem__(i)) != null; i++) {
                ...
                newkeywords[keywords.length + i] = ((PyString) key)
                        .internedString();
    ...
    public boolean isNumberType() {
        PyType type = getType();
        return type.lookup("__int__") != null
                || type.lookup("__float__") != null;
    }
    ...
    /**
     * Equivalent to the standard Python __len__ method. Part of the mapping
     * discipline.
     * 
    ...
    public int __len__() {
        throw Py.TypeError(String
                .format("object of type '%.200s' has no len()", getType()
                        .fastGetName()));
    }

    /**
     * Very similar to the standard Python __getitem__ method. Instead of
     * throwing a KeyError if the item isn't found, this just returns null.
     * 
     * Classes that wish to implement __getitem__ should override this method
     ...
     * <code>__finditem__(PyObject key)</code> with the appropriate args. The
     * only reason to override this method is for performance.
     * 
     * @param key
     ...
     * 
     * @param key
     *            the key to lookup in this sequence - <b> must be an interned
     *            string </b>.
     * @return the value corresponding to key or null if key is not found.
     * 
     * @see #__finditem__(PyObject)
    ...
    /**
     * Equivalent to the standard Python __getitem__ method. This variant takes
     * a primitive <code>int</code> as the key. This method should not be
     * overridden. Override the <code>__finditem__</code> method instead.
     * 
     * @param key
     *            the key to lookup in this container.
     * @return the value corresponding to that key.
     * @exception Py.KeyError
    ...
    /**
     * Equivalent to the standard Python __getitem__ method. This method should
     * not be overridden. Override the <code>__finditem__</code> method instead.
     * 
     * @param key
     *            the key to lookup in this container.
     * @return the value corresponding to that key.
    ...
    public void __setitem__(PyObject key, PyObject value) {
        throw Py.TypeError(String.format(
                "'%.200s' object does not support item assignment", getType()
                        .fastGetName()));
    }

    /**
     * A variant of the __setitem__ method which accepts a String as the key.
     * <b>This String must be interned</b>. By default, this will call
     * <code>__setitem__(PyObject key, PyObject value)</code> with the
     * appropriate args. The only reason to override this method is for
     * performance.
     * 
     * @param key
     *            the key whose value will be set - <b> must be an interned
     *            string </b>.
     * @param value
     *            the value to set this key to
     * 
     ...
     * <code>int</code> as the key. By default, this will call
     * <code>__setitem__(PyObject key, PyObject value)</code> with the
     * appropriate args. The only reason to override this method is for
     * performance.
     * 
    ...
    public void __delitem__(PyObject key) {
        throw Py.TypeError(String.format(
                "'%.200s' object doesn't support item deletion", getType()
                        .fastGetName()));
    }
     ...
     * <b>This String must be interned</b>. By default, this will call
     * <code>__delitem__(PyObject key)</code> with the appropriate args. The
     * only reason to override this method is for performance.
     * 
     * @param key
     *            the key who will be removed - <b> must be an interned string
     *            </b>.
     * @exception Py.KeyError
     *                if the key is not found in the container
     * 
     ...
     * From version 2.2, this method is the primary protocol for looping over
     * sequences.
     * <p>
     ...
     * </pre>
     * 
     * When iterating over a python sequence from java code, it should be done
     * with code like this:
     * 
     * <pre>
     ...
     * object. If this object doesn't support __iter__, a TypeException will be
     * raised when iterator is called on the returned Iterable.
     */
     ...
     * Returns null when the end of the sequence is reached.
     * 
     * @since 2.2
     */
     ...
     * <code>__findattr__(name.internedString)</code> with the appropriate args.
     * 
     * @param name
     ...
     * 
     * @param name
     *            the name to lookup in this namespace <b> must be an interned
     *            string </b>.
     * @return the value corresponding to name or null if name is not found
     **/
     ...
     * returned or a Py.AttributeError can be thrown, whatever is more correct,
     * efficient and/or convenient for the implementing class.
     * 
     * Client code should use {@link #__getattr__(String)} or
     * {@link #__findattr__(String)}. Both methods have a clear policy for
     * failed lookups.
     * 
     * @return The looked up value. May return null if the attribute is not
     *         found
     * @throws PyException
     *             (AttributeError) if the attribute is not found. This is not
     *             mandatory, null can be returned if it fits the implementation
     ...
     * 
     * By default, this method will call
     * <code>__getattr__(name.internedString)</code> with the appropriate args.
     * 
     * @param name
     *            the name to lookup in this namespace
     * @return the value corresponding to name
     * @exception Py.AttributeError
     ...
     * <code>String</code> as the name. This method can not be overridden.
    ...
    public void noAttributeError(String name) {
        throw Py.AttributeError(String.format(
                "'%.50s' object has no attribute '%.400s'", getType()
                        .fastGetName(), name));
    }

    public void readonlyAttributeError(String name) {
        // XXX: Should be an AttributeError but CPython throws TypeError for
        // read only
        // member descriptors (in structmember.c::PyMember_SetOne), which is
        // expected by a
    ...
    /**
     * Equivalent to the standard Python __setattr__ method. This method can not
     * be overridden.
     * 
     * @param name
     *            the name to lookup in this namespace
     ...
     * <b>This String must be interned</b>.
     * 
     * @param name
     *            the name whose value will be set - <b> must be an interned
     *            string </b>.
     * @param value
    ...
    /**
     * Equivalent to the standard Python __delattr__ method. This method can not
     * be overridden.
     * 
     * @param name
     ...
     * <b>This String must be interned</b>. By default, this will call
     * <code>__delattr__(PyString name)</code> with the appropriate args. The
     * only reason to override this method is for performance.
     * 
     * @param name
     *            the name which will be removed - <b> must be an interned
     *            string </b>.
     * @exception Py.AttributeError
     *                if the name doesn't exist
     * 
     ...
     * @return null if coercion is not implemented Py.None if coercion was not
     *         possible a single PyObject to use to replace o if this is
     *         unchanged; or a PyObject[2] consisting of replacements for this
     *         and o.
     **/
     ...
     * 
     * This method can not be overridden. To implement __coerce__ functionality,
     * override __coerce_ex__ instead.
     * 
     ...
     * @param pyo
     *            the other object involved in the coercion.
     * @return a tuple of this object and pyo coerced to the same type or
     *         Py.NotImplemented if no coercion is possible.
     ...
     * 
     * This is safe to be used from subclasses exposing '__coerce__' (as opposed
     * to {@link #__coerce__(PyObject)}, which calls the virtual method
     * {@link #__coerce_ex__(PyObject)})
     * 
     * @param o
     *            either a PyObject[2] or a PyObject, as given by
     *            {@link #__coerce_ex__(PyObject)}.
     */
    ...
    private final int _default_cmp(PyObject other) {
        ...
        String otherTypeName = other.isNumberType() ? "" : otherType
                .fastGetName();
    ...
    /*
     * Like _cmp_unsafe but limited to ==/!= as 0/!=0, thus it avoids to invoke
     * _default_cmp.
     */
    ...
    private final static PyObject check_recursion(ThreadState ts, PyObject o1,
            PyObject o2) {
    ...
    public PyObject _is(PyObject o) {
        // Access javaProxy directly here as is is for object identity, and at
        // best getJavaProxy
        // will initialize a new object with a different identity
        return this == o || (javaProxy != null && javaProxy == o.javaProxy) ? Py.True
                : Py.False;
    }
    ...
    /**
     * Equivalent to the standard Python __hex__ method Should only be
     * overridden by numeric objects that can be reasonably represented as a
     * hexadecimal string.
     * 
    ...
    /**
     * Equivalent to the standard Python __oct__ method. Should only be
     * overridden by numeric objects that can be reasonably represented as an
     * octal string.
     * 
    ...
    /**
     * Equivalent to the standard Python __int__ method. Should only be
     * overridden by numeric objects that can be reasonably coerced into an
     * integer.
     * 
    ...
    /**
     * Equivalent to the standard Python __long__ method. Should only be
     * overridden by numeric objects that can be reasonably coerced into a
     * python long.
     * 
    ...
    /**
     * Equivalent to the standard Python __float__ method. Should only be
     * overridden by numeric objects that can be reasonably coerced into a
     * python float.
     * 
    ...
    /**
     * Equivalent to the standard Python __complex__ method. Should only be
     * overridden by numeric objects that can be reasonably coerced into a
    ...
    /**
     * Equivalent to the standard Python __trunc__ method. Should only be
     * overridden by numeric objects that can reasonably be truncated to an
     * Integral.
     * 
    ...
    /**
     * Equivalent to the standard Python conjugate method. Should only be
     * overridden by numeric objects that can calculate a complex conjugate.
     * 
    ...
    /**
     * Equivalent to the standard Python bit_length method. Should only be
     * overridden by numeric objects that can calculate a bit_length.
     * 
    ...
    public PyObject __pos__() {
        throw Py.TypeError(String.format(
                "bad operand type for unary +: '%.200s'", getType()
                        .fastGetName()));
    }
    ...
    public PyObject __abs__() {
        throw Py.TypeError(String
                .format("bad operand type for abs(): '%.200s'", getType()
                        .fastGetName()));
    }
     ...
     * @throws a
     *             Py.TypeError if not supported
     **/
    public PyObject __index__() {
        throw Py.TypeError(String.format(
                "'%.200s' object cannot be interpreted as an index", getType()
                        .fastGetName()));
    }
    ...
    protected final String _unsupportedop(String op, PyObject o2) {
        Object[] args = { op, getType().fastGetName(),
                o2.getType().fastGetName() };
     ...
     * 
     * {0} is the op name. {1} is the left operand type. {2} is the right
     * operand type.
     */
     ...
     * @param o3
     *            the modulus to perform this operation in or null if no modulo
     *            is to be used
    ...
    /**
     * Determine if the binary op on types t1 and t2 is an add operation dealing
     * with a str/unicode and a str/unicode subclass.
     * 
     * This operation is special cased in _binop_rule to match CPython's
     * handling; CPython uses tp_as_number and tp_as_sequence to allow
     * string/unicode subclasses to override the left side's __add__ when that
     * left side is an actual str or unicode object (see test_concat_jy for
     * examples).
     * 
     * @param t1
     *            left side PyType
    ...
    private boolean isStrUnicodeSpecialCase(PyType t1, PyType t2, String op) {
        ...
        return (op == "+")
                && (t1 == PyString.TYPE || t1 == PyUnicode.TYPE)
    ...
    private PyObject _binop_rule(PyType t1, PyObject o2, PyType t2,
        ...
        if (impl2 != null
                ...
                && (t2.isSubType(t1) && !Py.isSubClass(where1, where2)
                        && !Py.isSubClass(t1, where2) || isStrUnicodeSpecialCase(
                            t1, t2, op))) {
            PyObject tmp = o1;
            o1 = o2;
            o2 = tmp;
     ...
     * 
     * @param other
     *            the object to perform this binary operation with (the
     *            right-hand operand).
    ...
    /**
     * Implements the Python expression <code>this + o2</code> when this and o2
     * have the same type or are builtin types.
     * 
     * @param o2
     *            the object to perform this binary operation with.
     * @return the result of the add.
     ...
     *            the object to perform this binary operation with (the
     *            right-hand operand).
     * @return the result of the floordiv, or null if this operation is not
     *         defined
     **/
     ...
     *            the object to perform this binary operation with (the
     *            right-hand operand).
     * @return the result of the ifloordiv, or null if this operation is not
     *         defined
     **/
    ...
    /**
     * Implements the Python expression <code>this //= o2</code> when this and
     * o2 have the same type or are builtin types.
     * 
     * @param o2
     *            the object to perform this inplace binary operation with.
     * @return the result of the ifloordiv.
     ...
     *            the object to perform this binary operation with (the
     *            right-hand operand).
     * @return the result of the truediv, or null if this operation is not
     *         defined
     **/
     ...
     *            the object to perform this binary operation with (the
     *            right-hand operand).
     * @return the result of the itruediv, or null if this operation is not
     *         defined
     **/
     ...
     *            the object to perform this binary operation with (the
     *            right-hand operand).
     * @return the result of the idivmod, or null if this operation is not
     *         defined
     **/
    ...
    /**
     * Implements the Python expression <code>this divmod o2</code> when this
     * and o2 have the same type or are builtin types.
     * 
     * @param o2
     *            the object to perform this binary operation with.
     * @return the result of the divmod.
     ...
     *            the object to perform this binary operation with (the
     *            right-hand operand).
     * @return the result of the ilshift, or null if this operation is not
     *         defined
     **/
     ...
     *            the object to perform this binary operation with (the
     *            right-hand operand).
     * @return the result of the irshift, or null if this operation is not
     *         defined
     **/
        ...
        try {
            ...
            if (e.value.getJavaProxy() != null) {
                ...
                if (Options.showPythonProxyExceptions) {
                    Py.stderr
                            .println("Exception in Python proxy returning to Java:");
                    Py.printException(e);
                }
            }
            throw e;
    ...
    /**
     * Shortcut for calling a method on a PyObject from Java. This form is
     * equivalent to o.__getattr__(name).__call__(args, keywords)
     * 
     * @param name
     *            the name of the method to call. This must be an interned
     *            string!
     * @param args
    ...
    /**
     * Shortcut for calling a method on a PyObject with one extra initial
     * argument.
     * 
     * @param name
     *            the name of the method to call. This must be an interned
     ...
     **/
    public PyObject invoke(String name, PyObject arg1, PyObject[] args,
            String[] keywords) {
        PyObject f = __getattr__(name);
    ...
    public void setDict(PyObject newDict) {
        ...
        throw Py.TypeError("can't set attribute '__dict__' of instance of "
                + getType().fastGetName());
    }
     ...
     * 
     * @param obj
     *            - the instance accessing this descriptor. Can be null if this
     *            is being accessed by a type.
     * @param type
     *            - the type accessing this descriptor. Will be null if obj
     *            exists as obj is of the type accessing the descriptor.
    ...
    private void hackCheck(String what) {
        if (this instanceof PyType && ((PyType) this).builtin) {
            throw Py.TypeError(String.format(
                    "can't apply this %s to %s object", what,
                    objtype.fastGetName()));
        }
    }
    ...
    /**
     * Used for pickling. If the subclass specifies __reduce__, it will override
     * __reduce_ex__ in the base-class, even if __reduce_ex__ was called with an
     * argument.
     * 
     * @param arg
     *            PyInteger specifying reduce algorithm (method without this
    ...
    final PyObject object___reduce_ex__(int arg) {
        ...
        PyObject objreduce = (new PyObject()).getType().__findattr__(
                "__reduce__");
    ...
    private PyObject reduce_2() {
        ...
        return new PyTuple(newobj, new PyTuple(args2), state, listitems,
                dictitems);
    }
    ...
    public static PyObject object___subclasshook__(PyType type,
            PyObject subclass) {
        return Py.NotImplemented;
    }
    ...
    // TODO - remove when all generated users are migrated to @Exposed and
    // asInt()
     ...
     * 
     * Throws a Python exception on Overflow if specified an exception type for
     * err.
     * 
     * @param err
    ...
    /**
     * Truffle. The purpose of this method is to support PyObjectContainer
     * 
     * @return
     */
...
/*
 * A very specialized tuple-like class used when detecting cycles during object
 * comparisons. This classes is different from an normal tuple by hashing and
 * comparing its elements by identity.
 */
