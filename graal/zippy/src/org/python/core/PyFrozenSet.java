...
public class PyFrozenSet extends BaseSet {
    ...
    @ExposedNew
    public static PyObject frozenset___new__(PyNewWrapper new_, boolean init,
            PyType subtype, PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("frozenset", args, keywords,
                new String[] { "iterable" }, 0);
    ...
    final PyObject frozenset_copy() {
        ...
        // subclasses should revert to normal behavior of creating a new
        // instance
        return baseset_copy();
    }
