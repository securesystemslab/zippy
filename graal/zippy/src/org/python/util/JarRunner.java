 ...
 * name "__run__" as arg 0 for consistancy with Python expectations), and import
 * __run__. It is intended to be used to allow an application jarred up with
 * Jython's runtime to run like "java -jar foo.jar". It requires a __run__.py in
 * the jar that will execute the program, and the following entry in the
 * manifest:
 * 
