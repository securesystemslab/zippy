...
/**
 * Connect using through a javax.sql.DataSource or
...
public class Connectx extends PyObject {
    ...
    private final PyString doc = new PyString(
            "establish a connection through a javax.sql.DataSource or "
                    + "javax.sql.ConnectionPooledDataSource");
    ...
    public PyObject __call__(PyObject[] args, String[] keywords) {
        ...
        try {
            ...
            throw zxJDBC.makeException(zxJDBC.DatabaseError,
                    "unable to instantiate datasource");
        }
        ...
        for (int i = 0; i < kws.length; i++) {
            ...
            if (methodName.length() > SET.length()) {
                ...
                invoke(datasource,
                        SET + methodName.substring(0, 1).toUpperCase()
                                + methodName.substring(1), value);
            }
        }
        ...
        try {
            if (datasource instanceof ConnectionPoolDataSource) {
                c = ((ConnectionPoolDataSource) datasource)
    ...
    protected void invoke(Object src, String methodName, Object value) {
        ...
        try {
            ...
            throw zxJDBC.makeException("invocation target exception for "
                    + exceptionMsg);
        }
    ...
    /**
     * Try to find the method by the given name. If failing that, see if the
     * valueClass is perhaps a primitive and attempt to recurse using the
     * primitive type. Failing that return null.
     */
    protected Method getMethod(Class<?> srcClass, String methodName,
            Class<?> valueClass) {
        Method method = null;
