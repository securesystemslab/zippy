 ...
 * <p/>
 * <p>
 * <b>Note:</b> MySql does not return the correct count for a <a
 * href="http://www.mysql.com/doc/D/E/DELETE.html">delete</a> statement that has
 * no <code>where</code> clause. Therefore, to assure the correct update count
 * is returned, either include a <code>where</code> clause, or understand that
 * the value will always be <code>0</code>.
 * </p>
 * 
 * @author brian zimmer
...
public class UpdateCountDataHandler extends FilterDataHandler {
    ...
    /**
     * Handle capturing the update count. The initial value of the updateCount
     * is <code>-1</code>.
     */
    public UpdateCountDataHandler(DataHandler datahandler) {
        ...
        if (!once) {
            Py.writeError("UpdateCountDataHandler",
                    zxJDBC.getString("updateCountDeprecation"));
            once = true;
        }
    ...
    /**
     * Sets the update count to <code>-1</code> prior to the statement being
     * executed.
     */
