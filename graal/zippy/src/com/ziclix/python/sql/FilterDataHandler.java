...
/**
 * A FilterDataHandler contains some other DataHandler, which it uses as its
 * basic source of functionality, possibly transforming the calls along the way
 * or providing additional functionality. The class FilterDataHandler itself
 * simply overrides all methods of DataHandler with versions that pass all
 * requests to the contained data handler.
 * 
 * @author brian zimmer
 */
public abstract class FilterDataHandler extends DataHandler {
     ...
     * delegation.
     * 
     * @return a list of datahandlers chained together through the use of
     *         delegation
     */
