...
public abstract class BaseDB {
    ...
    /**
     * Create a new constructor and optionally bind a new DataHandler. The new
     * DataHandler must act as a Decorator, having a single argument constructor
     * of another DataHandler. The new DataHandler is then expected to delegate
     * all calls to the original while enhancing the functionality in any matter
     * desired. This allows additional functionality without losing any previous
     * work or requiring any complicated inheritance dependencies.
     */
    protected PyCursor cursor() {
        ...
        if ((origDataHandler != null) && (this.dataHandler != null)) {
            ...
            if (cons == null) {
                String msg = zxJDBC.getString("invalidCons",
                        new Object[] { this.dataHandler.getName() });
