...
public class ScriptEngineIOTest extends TestCase {
    ...
    public void testEvalWithReader() throws ScriptException,
    ...
    public void testGetInterfaceCharSequence1() throws ScriptException,
            IOException {
        ...
        CharSequence seq = invocableEngine.getInterface(engine.get("c"),
                CharSequence.class);
        assertEquals("aaa", seq.toString());
    }

    public void testGetInterfaceCharSequence2() throws ScriptException,
            IOException {
        ScriptEngineManager manager = new ScriptEngineManager();
        ...
        assertNull(pythonEngine.eval("from java.lang import StringBuilder\r\n"
                + "c = StringBuilder(\"abc\")\r\n"));
        CharSequence seq = invocableEngine.getInterface(pythonEngine.get("c"),
                CharSequence.class);
