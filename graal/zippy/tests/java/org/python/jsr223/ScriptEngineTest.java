...
public class ScriptEngineTest extends TestCase {
    ...
    public void testScriptFilename() {
        ...
        scriptContext.setAttribute(ScriptEngine.FILENAME, "sample.py",
    ...
    public void testEvalReader() throws ScriptException {
        ...
        assertEquals(Integer.valueOf(5),
                pythonEngine.eval(new StringReader("x")));
    }
    ...
    public void testThreadLocalBindings() throws ScriptException,
    ...
    public void testInvoke() throws ScriptException, NoSuchMethodException {
        ...
        assertEquals(Integer.valueOf(5),
                invocableEngine.invokeFunction("f", Integer.valueOf(-5)));
        assertEquals("spam",
                invocableEngine.invokeMethod(new PyString("  spam  "), "strip"));
    ...
    public void testInvokeFunctionNoSuchMethod() throws ScriptException {
        ScriptEngineManager manager = new ScriptEngineManager();
        Invocable invocableEngine = (Invocable) manager
    ...
    public void testGetInterface() throws ScriptException, IOException {
        ...
        readable = invocableEngine.getInterface(pythonEngine.get("c"),
                Readable.class);
        assertEquals(2, readable.read(null));
    }

    public void testInvokeMethodNoSuchArgs() throws ScriptException,
            NoSuchMethodException {
        ScriptEngineManager manager = new ScriptEngineManager();
        ScriptEngine pythonEngine = manager.getEngineByName("python");
        Invocable invocableEngine = (Invocable) pythonEngine;

        Object newStringCapitalize = invocableEngine.invokeMethod("test",
                "capitalize");
    ...
    public void testIssue1681() throws ScriptException {
        ...
        ScriptEngine pythonEngine = manager.getEngineByName("python");
        pythonEngine
                .eval("from org.python.jsr223 import PythonCallable\n"
