...
public class IndexerTest extends TestBase {
    ...
    public void testNativeModulesAvailable() throws Exception {
        for (String name : new String[] { "array", "ctypes", "errno", "math",
                "operator", "os", "signal", "sys", "thread", "time", }) {
    ...
    public void testClassTypeBuiltinAttrs() throws Exception {
        ...
        buildIndex(file);
        NModuleType module = (NModuleType) idx.moduleTable
                .lookupType(abspath(file));
    ...
    public void testMethodBuiltinAttrs() throws Exception {
        ...
        NBinding method = mtable.lookupType("MyClass").getTable()
                .lookup("__init__");
        ...
        NType ftype = mtable.lookupType("MyClass").getTable()
                .lookupType("__init__");
        assertTrue(ftype.isFuncType());

        NBinding c = mtable.lookup("MyClass");
        for (String special : new String[] { "im_class", "__class__",
                "im_self", "__self__" }) {
    ...
    public void testAutoClassBindings() throws Exception {
        ...
        assertEquals(((NDictType) b.getType()).getKeyType(),
                idx.builtins.BaseStr);
    ...
    public void testUnqualifiedSamePkgImport() throws Exception {
        ...
        assertReference("pkg.animal.reptile.croc",
                nthIndexOf(snakeSrc, "croc", 2));
        assertReference("pkg.animal.reptile.croc.Gavial",
                snakeSrc.indexOf("Gavial"));
    }
    ...
    public void testAbsoluteImport() throws Exception {
        ...
        assertReference("pkg.plant.poison.eggplant",
                nthIndexOf(src, "eggplant", 1));
        assertReference("pkg.plant.poison.eggplant",
                nthIndexOf(src, ".eggplant", 2) + 1);
    }
    ...
    public void testImportStarAll() throws Exception {
        ...
        assertNoReference("Should not have imported 'd'", "pkg.misc.moduleA.d",
                src.indexOf("d #"), 1);
    }
    ...
    public void testTempName() throws Exception {
        String src = index("tmpname.py", "def purge():", "  cache.clear()",
                "cache = {}");
    ...
    public void testTempAttr() throws Exception {
        String src = index("tmpattr.py", "x = app.usage", "app.usage = 'hi'");
    ...
    public void testTempAttrOnParam() throws Exception {
        String src = index("tmpattr_param.py", "def foo(x):",
                "  x.hello = 'hi'", "def bar(y=None):", "  y.hello = 'hola'");
    ...
    public void testParamDefaultLambdaBinding() throws Exception {
        String src = index("test.py", "def foo(arg=lambda name: name + '!'):",
                "  x = arg('hi')");
    ...
    public void testNestedLambdaParam() throws Exception {
        String src = index("test.py", "def util(create):", "  return create()",
                "z = lambda:util(create=lambda: str())", "y = z()()");
    ...
    public void testReassignAttrOfUnknown() throws Exception {
        ...
        String src = index("reassign.py", "app.foo = 'hello'", "app.foo = 2");
    ...
    public void testRefToProvisionalBinding() throws Exception {
        String src = index("provisional.py", "for a in []:", "  a.dump()",
                "for a in []:", "  a.dump()");
    ...
    public void testRefToProvisionalBindingNewType() throws Exception {
        String src = index("provisional.py", "for b in []:", "  b.dump()",
                "for b in ():", "  b.dump()");
        assertModuleBinding("provisional");
    ...
    public void testSkipClassScope() throws Exception {
        String src = index("skipclass.py", "def aa():", "  xx = 'foo'",
                "  class bb:", "    xx = 10", "    def cc(self):",
                "      print bb.xx", "      print xx");
    ...
    public void testLambdaArgs() throws Exception {
        String src = index("lambda_args.py", "y = lambda x='hi': x.upper()",
    ...
    public void testFunArgs() throws Exception {
        String src = index("funargs.py", "def foo(x, y='hi'):", "  z = 9",
                "  return x + y.upper() + z");
    ...
    public void testDatetime() throws Exception {
        String src = index("date_time.py",
                "from datetime import datetime as dt", "import datetime",
                "now = dt.now()", "d = now.date()", "tz = now.tzinfo");
    ...
    public void testUnpackList() throws Exception {
        index("unpacklist.py", "a = [1, 2]", "(b, c) = [3, 4]",
                "[d, e] = ['hi', 'there']");
    ...
    public void testStringSlice() throws Exception {
        String src = index("slicestring.py", "a = 'hello'[2]",
                "b = 'hello'[2:4]", "test = 'testing'", "test[-3:].lower()");
    ...
    public void testUnionStringSliceTempAttr() throws Exception {
        String src = index("tmpattr_slice.py", "def foo(filename):",
                "  module = filename or '<unknown>'", "  module[-3:].lower()");
        assertCall("__builtin__.str.lower", src.lastIndexOf("lower"));
    }

    public void testSelfBinding() throws Exception {
        String src = index("selfish.py", "class Foo():", "  def hello(self):",
                "    print self");
    ...
    public void testInstanceAttrs() throws Exception {
        String src = index("attr.py", "class Foo():", "  def __init__(self):",
                "    self.elts = []", "  def add(self, item):",
    ...
    public void testInstanceAttrsWithStdLib() throws Exception {
        ...
        String src = index("dice.py", "import random", "class Dice(object):",
                "  def __init__(self):", "    self.__random = random.Random()",
                "  def set_seed(self, seed):", "    self.__random.seed(seed)");
    ...
    public void testOsPath() throws Exception {
        String src = index("test.py", "from os import path",
                "print path.devnull",
    ...
    public void testImportOsPath() throws Exception {
        String src = index("test.py", "import os.path", "print os.path.devnull");
    ...
    public void testExceptionsModule() throws Exception {
        String src = index("test.py", "import exceptions",
    ...
    public void testDupFunctionDecl() throws Exception {
        String src = index("test.py", "if x:", "  def a(args):",
                "    print args", "elif y:", "  def a(args):", "    print args");
        assertFunctionBinding("test.a");
        assertParamBinding("test.a@args");
    }

    public void testResolveExportedNames() throws Exception {
        String src = index("test.py",
                "__all__ = ['foo', 'bar' + 'baz', 'one', 'two']",
                "def foo(x):", "  return x", "bar = 6", "baz = 7",
                "barbaz = 8", "one = 'hi'", "two = 'there'");
        ...
        assertNoReference("Should not have referenced 'bar'", "test.bar",
                src.indexOf("bar"), 3);
    }

    public void testImportFromPlusAssign() throws Exception {
        String src = index("test.py", "from os import sep", "os = 10",
                "print os");
    ...
    public void testCircularTypeFunAndTuple() throws Exception {
        String src = index("test.py", "def foo():", "  return (foo,)");
        assertFunctionBinding("test.foo");
    ...
    public void testCircularTypeXInOwnList() throws Exception {
        String src = index("test.py", "x = (2,)", "y = [x]", "x = y");
        ...
        assertTrue("Expected tuple: " + array[other],
                array[other].isTupleType());
        assertEquals(1, array[other].asTupleType().getElementTypes().size());
        assertEquals(idx.builtins.BaseNum, array[other].asTupleType()
        ...
        if (array0List) {
            ...
            assertEquals("<UnionType:[<ListType:" + ttype + ">," + ref + "]>",
                    s);
        } else {
            // union(tuple, list(unknown(ref)))
            assertEquals("<UnionType:[" + ttype + ",<ListType:" + ref + ">]>",
                    s);
        }
    }
    ...
    public void testFunReturn() throws Exception {
        ...
        String src = index("fret.py", "def foo(x): return x", "a = foo('a')",
                "b = foo('b')", "c = foo('c')");
    ...
    public void testDecoratorSyntax() throws Exception {
        ...
        String src = index("deco.py", deco1, deco2, "def foo(): pass");
    ...
    public void testBasicDecoratorSyntax() throws Exception {
        String src = index("deco.py",
                "def deco1(func): print 'hello'; return func", "@deco1()",
                "def foo(): pass");
