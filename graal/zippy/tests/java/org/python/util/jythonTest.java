...
public class jythonTest extends TestCase {
    ...
    public void testNewInterpreter_registry() throws Exception {
        PySystemState.registry.setProperty(PYTHON_CONSOLE,
                "org.python.util.InteractiveConsole");
        assertEquals(InteractiveConsole.class, invokeNewInterpreter(true)
                .getClass());
    }
    ...
    public void testNewInterpreter_NonInteractive() throws Exception {
        assertEquals(InteractiveConsole.class, invokeNewInterpreter(false)
                .getClass());
    }

    /**
     * Invoke the private static method 'newInterpreter(boolean)' on
     * jython.class
     * 
     * @throws Exception
     */
    private InteractiveConsole invokeNewInterpreter(boolean interactiveStdin)
            throws Exception {
        Method method = jython.class.getDeclaredMethod("newInterpreter",
                Boolean.TYPE);
