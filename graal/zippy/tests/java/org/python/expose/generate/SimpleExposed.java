...
public class SimpleExposed extends PyObject {
    ...
    public static int defaultsclassmethod(PyType onType, String possiblyNull,
            PyObject possiblyNone) {
    ...
    @ExposedMethod
    public int needsThreadStateWide(ThreadState state, PyObject[] args,
            String[] kws) {
        if (state == null) {
            return -1;
        }
    ...
    public static String needsThreadStateClass(ThreadState state,
            PyType onType, String s, String possiblyNull) {
        if (state != null) {
