...
public class CSVSink implements Sink {
     ...
     * 
     * @param writer
     *            the PrintWriter to which data will be written
     */
    ...
    /**
     * All data will be written to the given PrintWriter. If the converters
     * param is not None, then an attempt will be made to convert the object
     * using the given converter.
     * 
     * @param writer
     *            the PrintWriter to which data will be written
     * @param converters
     *            an indexed dictionary of callable objects used for converting
     *            objects to strings
     */
