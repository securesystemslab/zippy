...
public class BCP extends PyObject implements ClassDictInit {
    ...
    public void __setattr__(String name, PyObject value) {
        ...
        if ("destinationDataHandler".equals(name)) {
            ...
            this.batchsize = ((Number) value.__tojava__(Number.class))
                    .intValue();
        } else if ("queuesize".equals(name)) {
            this.queuesize = ((Number) value.__tojava__(Number.class))
                    .intValue();
        } else {
    ...
    static public void classDictInit(PyObject dict) {
        dict.__setitem__("bcp",
                new BCPFunc("bcp", 0, 1, 2, zxJDBC.getString("bcp")));
        dict.__setitem__("batchsize",
                Py.newString(zxJDBC.getString("batchsize")));
        dict.__setitem__("queuesize",
                Py.newString(zxJDBC.getString("queuesize")));
     ...
     * @param exclude
     *            the columns to be excluded from insertion on the destination,
     *            all if None
     * @param toTable
     *            if non-null, the table in the destination db, otherwise the
     *            same table name as the source
     * @param bindings
     *            the optional bindings for the destination, this allows
     *            morphing of types during the copy
     * @return the count of the total number of rows bulk copied, -1 if the
     *         query returned no rows
     */
    protected PyObject bcp(String fromTable, String where, PyObject params,
            PyObject include, PyObject exclude, String toTable,
            PyObject bindings) {

        Pipe pipe = new Pipe();
        String _toTable = (toTable == null) ? fromTable : toTable;
        DBSource source = new DBSource(this.source, sourceDH, fromTable, where,
                include, params);
        DBSink sink = new DBSink(this.destination, destDH, _toTable, exclude,
...
class BCPFunc extends PyBuiltinMethodSet {
    ...
    public PyObject __call__(PyObject arg) {
        ...
        case 0:
            ...
            PyObject count = bcp.bcp(table, null, Py.None, Py.None, Py.None,
                    null, Py.None);
    ...
    public PyObject __call__(PyObject arga, PyObject argb) {
        ...
        case 0:
            ...
            PyObject count = bcp.bcp(table, where, Py.None, Py.None, Py.None,
                    null, Py.None);
    ...
    public PyObject __call__(PyObject arga, PyObject argb, PyObject argc) {
        ...
        case 0:
            ...
            String where = (String) argb.__tojava__(String.class);
            PyObject count = bcp.bcp(table, where, argc, Py.None, Py.None,
                    null, Py.None);
    ...
    public PyObject __call__(PyObject[] args, String[] keywords) {
        ...
        case 0:
            ...
            /*
             * B.bcp(table, [where=None, params=None, include=None,
             * exclude=None, toTable=None, bindings=None])
             */
            String where = null;
            PyObject params = Py.None;
            PyArgParser parser = new PyArgParser(args, keywords);
            String table = (String) parser.arg(0, Py.None).__tojava__(
                    String.class);
            ...
            if (parser.numArg() >= 2) {
                where = (String) parser.arg(1, Py.None)
                        .__tojava__(String.class);
            }

            if (where == null) {
                where = (String) parser.kw("where", Py.None).__tojava__(
                        String.class);
            }
            ...
            String toTable = (String) parser.kw("toTable", Py.None).__tojava__(
                    String.class);
            ...
            PyObject count = bcp.bcp(table, where, params, include, exclude,
                    toTable, bindings);
