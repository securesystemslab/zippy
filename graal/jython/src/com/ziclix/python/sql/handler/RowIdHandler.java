...
public abstract class RowIdHandler extends FilterDataHandler {
    ...
    /**
     * Return the name of the method that returns the last row id. The method
     * can take no arguments but the return type is flexible and will be figured
     * out by the Jython runtime system.
     * 
     * @return
     */
