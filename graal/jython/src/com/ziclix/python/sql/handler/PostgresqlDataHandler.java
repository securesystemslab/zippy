...
public class PostgresqlDataHandler extends RowIdHandler {
    ...
    public PyObject getPyObject(ResultSet set, int col, int type)
        ...
        case Types.OTHER:
            ...
            // it seems pg doesn't like to handle OTHER types as anything but
            // strings
    ...
    public void setJDBCObject(PreparedStatement stmt, int index,
        ...
        case Types.LONGVARCHAR:
            ...
            String varchar;
            // Postgresql driver can't handle the setCharacterStream() method so
    ...
    public void setJDBCObject(PreparedStatement stmt, int index, PyObject object)
            throws SQLException {
        // PostgreSQL doesn't support BigIntegers without explicitely setting
        // the
        // type.
