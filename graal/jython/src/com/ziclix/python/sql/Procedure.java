...
/**
 * This class provides the necessary functionality to call stored procedures. It
 * handles managing the database metadata and binding the appropriate
 * parameters.
 * 
 * @author brian zimmer
 */
public class Procedure extends Object {
    ...
    /**
     * This method determines whether the param at the specified index is an IN
     * or INOUT param for a stored procedure. This is only configured properly
     ...
     * <p/>
     * As of now, all parameters variables are created and no support for named
     * variable calling is supported.
     * 
     * @return String
     */
    public String toSql() throws SQLException {
        ...
        if (this.columns != Py.None) {
            for (int i = 0, len = this.columns.__len__(); i < len; i++) {
                ...
                default:
                    throw zxJDBC.makeException(zxJDBC.DataError,
    ...
    protected void registerOutParameters(CallableStatement statement)
        ...
        for (int i = 0, len = this.columns.__len__(); i < len; i++) {
            ...
            case DatabaseMetaData.procedureColumnOut:
            case DatabaseMetaData.procedureColumnReturn:
                cursor.datahandler.registerOut(statement, i + 1, colType,
    ...
    protected void fetchColumns() throws SQLException {
        ...
        try {
            ...
            pec.procedurecolumns(procedureCatalog, procedureSchema,
                    procedureName, Py.None);
    ...
    /**
     * The value for a missing schema or catalog. This value is used to find the
     * column names for the procedure. Not all DBMS use the same default value;
     * for instance Oracle uses an empty string and SQLServer a null. This
    ...
    /**
     * Construct a procedure name for the relevant schema and catalog
     * information.
     */
