...
public interface DateFactory {
     ...
     * @return PyObject
     */
    public PyObject Timestamp(int year, int month, int day, int hour,
            int minute, int second);

    /**
     * This function constructs an object holding a date value from the given
     * ticks value (number of seconds since the epoch; see the documentation of
     * the standard Python <i>time</i> module for details).
     * <p/>
     * <i>Note:</i> The DB API 2.0 spec calls for time in seconds since the
     * epoch while the Java Date object returns time in milliseconds since the
     * epoch. This module adheres to the python API and will therefore use time
     * in seconds rather than milliseconds, so adjust any Java code accordingly.
     * 
     * @param ticks
