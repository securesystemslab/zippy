...
public class BaseTypeBuilder implements TypeBuilder {
    ...
    public BaseTypeBuilder(String name, Class<?> typeClass, Class<?> baseClass,
            boolean isBaseType, String doc, PyBuiltinMethod[] meths,
            PyDataDescr[] descrs, PyNewWrapper newWrapper) {
