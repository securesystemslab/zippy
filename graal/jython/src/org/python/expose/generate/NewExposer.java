...
public class NewExposer extends Exposer {
    ...
    public NewExposer(Type onType, int access, String methodName, String desc,
            String[] exceptions) {
    ...
    private void generateNewImpl() {
        ...
        mv.visitMethodInsn(INVOKESTATIC, onType.getInternalName(), name,
                NEW_DESCRIPTOR);
        endMethod(ARETURN);
    }
