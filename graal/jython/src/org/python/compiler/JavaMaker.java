...
public class JavaMaker extends ProxyMaker {
    ...
    @Override
    public void addConstructor(String name, Class<?>[] parameters,
            Class<?> ret, String sig, int access) throws Exception {
        ...
        code.visitMethodInsn(INVOKEVIRTUAL, classfile.name, "__initProxy__",
                makeSig("V", $objArr));
    ...
    public void addProxy() throws Exception {
        ...
        // _initProxy method
        Code code = classfile.addMethod("__initProxy__", makeSig("V", $objArr),
                Modifier.PUBLIC);
