...
public class PyScriptEngine extends AbstractScriptEngine implements Compilable,
        Invocable {
    ...
    PyScriptEngine(ScriptEngineFactory factory) {
        ...
        interp = PythonInterpreter
                .threadLocalStateInterpreter(new PyScriptEngineScope(this,
                        context));
    }
    ...
    private Object eval(PyCode code, ScriptContext context)
            throws ScriptException {
        try {
    ...
    private PyCode compileScript(String script, ScriptContext context)
        ...
        try {
            String filename = (String) context
                    .getAttribute(ScriptEngine.FILENAME);
            if (filename == null) {
    ...
    public Object invokeMethod(Object thiz, String name, Object... args)
        ...
        try {
            ...
            // return
            // method.__call__(Py.javas2pys(args)).__tojava__(Object.class);
            PyObject result;
            if (args != null) {
    ...
    public <T> T getInterface(Class<T> clazz) {
        return getInterface(new PyModule("__jsr223__", interp.getLocals()),
                clazz);
    }
        ...
        T proxy = (T) Proxy.newProxyInstance(clazz.getClassLoader(),
                new Class[] { clazz }, new InvocationHandler() {
                    public Object invoke(Object proxy, Method method,
                        ...
                        try {
                            interp.setLocals(new PyScriptEngineScope(
                                    PyScriptEngine.this, context));
                            PyObject pyMethod = thiz.__findattr__(method
                                    .getName());
                            if (pyMethod == null)
        ...
        try {
            ...
            if (__builtin__.isinstance(value, Py.SyntaxError)) {
                ...
                se = new ScriptException(Py.formatException(type, value),
                        ...
                        lineno == null ? 0 : lineno.asInt(), offset == null ? 0
                                : offset.asInt());
            } else if (tb != null) {
                String filename;
