...
public class PyScriptEngineFactory implements ScriptEngineFactory {
    ...
    public String getEngineVersion() {
        return String.format("%s.%s.%s", Version.PY_MAJOR_VERSION,
                Version.PY_MINOR_VERSION, Version.PY_MICRO_VERSION);
    }
    ...
    public String getLanguageVersion() {
        return String.format("%s.%s", Version.PY_MAJOR_VERSION,
    ...
    public List<String> getMimeTypes() {
        return Collections.unmodifiableList(Arrays.asList("text/python",
                "application/python", "text/x-python", "application/x-python"));
    }
