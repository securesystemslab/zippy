 ...
 * should not use this module directly, but import the csv.py module instead.
 */
public class _csv implements ClassDictInit {

    public static PyString __doc__ = Py
            .newString("CSV parsing and writing.\n"
                    + "\n"
    ...
    public static void register_dialect(PyObject[] args, String[] keywords) {
        ...
        if (argc > 2) {
            throw Py.TypeError("register_dialect() expected at most 2 arguments, got "
                    + argc);
        }
    ...
    public static PyObject reader(PyObject[] args, String[] keywords) {
        ...
        PyObject iterator = Py.iter(ap.getPyObject(0),
                "argument 1 must be an iterator");
        PyObject dialect = ap.getPyObject(1, null);
        return new PyReader(iterator,
                dialectFromKwargs(dialect, args, keywords));
    }
    ...
    public static PyObject writer(PyObject[] args, String[] keywords) {
        ...
        return new PyWriter(writeline, dialectFromKwargs(dialect, args,
                keywords));
    }
     ...
     */
    private static ArgParser parseArgs(String funcName, PyObject[] args,
            String[] keywords) {
     ...
     */
    private static PyDialect dialectFromKwargs(PyObject dialect,
