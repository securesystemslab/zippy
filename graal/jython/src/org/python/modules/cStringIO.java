 ...
 * string buffer (also known as memory files). See the description on file
...
public class cStringIO {
    ...
    public static class StringIO extends PyIterator {
        ...
        public void close() {
            ...
            // Therefore, just leave it and let it be GC'ed when the enclosing
            // object is GC'ed
        ...
        /**
         * Read all data until EOF is reached. An empty string is returned when
        ...
        /**
         * Read at most size bytes from the file (less if the read hits EOF). If
         * the size argument is negative, read all data until EOF is reached. An
         ...
         * Read one entire line from the file. A trailing newline character is
         * kept in the string (but may be absent when a file ends with an
         * incomplete line). If the size argument is non-negative, it is a
         * maximum byte count (including the trailing newline) and an incomplete
        ...
        /**
         * Read and return a line without the trailing newline. Usind by cPickle
         * as an optimization.
         */
