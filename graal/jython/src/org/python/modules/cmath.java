...
public class cmath {
    ...
    public static PyObject acos(PyObject in) {
        ...
        return (c_prodi(log(x
                .__add__(i.__mul__(sqrt(one.__sub__(x.__mul__(x)))))))
                .__neg__());
    }
    ...
    public static PyComplex cos(PyObject in) {
        PyComplex x = complexFromPyObject(in);
        PyComplex r = new PyComplex(Math.cos(x.real) * math.cosh(x.imag),
    ...
    public static PyComplex cosh(PyObject in) {
        PyComplex x = complexFromPyObject(in);
        PyComplex r = new PyComplex(Math.cos(x.imag) * math.cosh(x.real),
