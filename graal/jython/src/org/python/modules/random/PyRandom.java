...
public class PyRandom extends PyObject {
     ...
     * PyInteger or PyLong, it uses the value, else it uses the hash function of
     * PyObject
     */
    ...
    final void Random_jumpahead(PyObject arg0) {
        if (!(arg0 instanceof PyInteger || arg0 instanceof PyLong)) {
            throw Py.TypeError(String.format(
                    "jumpahead requires an integer, not '%s'", arg0.getType()
                            .fastGetName()));
        }
     ...
     * lifted from _randommodule.c:random_random(), but we use &gt;&gt;&gt;
     * instead of &gt;&gt; to avoid sign problems.
     */
    @ExposedMethod
