...
final class FastLongMethodGenerator extends AbstractNumericMethodGenerator {
    ...
    private static final String[] methodNames = { "invokeVrL", "invokeLrL",
            "invokeLLrL", "invokeLLLrL", "invokeLLLLrL", "invokeLLLLLrL",
            "invokeLLLLLLrL" };
    ...
    final static int getMaximumFastLongParameters() {
        try {
            com.kenai.jffi.Invoker.class.getDeclaredMethod("invokeLLLLLLrL",
