...
class AllocatedNativeMemory extends BoundedNativeMemory implements
     ...
     * @param clear
     *            Whether the memory should be cleared (zeroed)
     ...
     *            The number of bytes to allocate
     * @param align
     *            The minimum alignment of the memory
     * @param clear
     *            Whether the memory should be cleared (zeroed)
     * @return A new {@link AllocatedDirectMemory}
     */
    static final AllocatedNativeMemory allocateAligned(int size, int align,
            boolean clear) {
