...
public class jffi implements ClassDictInit {
    ...
    public static PyObject dlopen(PyObject name, PyObject mode) {
        return new DynamicLibrary(name != Py.None ? name.asString() : null,
                mode.asInt());
    }
    ...
    public static PyObject memset(PyObject dst, PyObject value, PyObject length) {
        com.kenai.jffi.MemoryIO.getInstance().setMemory(getMemoryAddress(dst),
                length.asInt(), (byte) value.asInt());
        return Py.None;
    }
}
