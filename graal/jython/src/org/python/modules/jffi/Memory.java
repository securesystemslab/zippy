...
public interface Memory {
     ...
     * 
     * @param offset
     *            The offset within the existing memory area to start the new
     *            <tt>MemoryIO</tt> at.
     ...
     * <p>
     * A native long is 32bits on either ILP32 or LLP64 architectures, and 64
     * bits on an LP64 architecture.
     * </p>
     * <p>
     * This means that it will always read a 32bit value on Windows, but on Unix
     * systems such as MacOS or Linux, it will read a 32bit value on 32bit
     ...
     *         memory pointed to by the address.
     */
     ...
     * @param len
     *            The number of bytes of the byte array to write to the memory
     *            area. (not including zero byte)
     */
    public void putZeroTerminatedByteArray(long offset, byte[] bytes, int off,
            int len);
     ...
     * 
     * @param offset
     *            The offset within the memory area to start writing the
     *            doubles.
     * @param src
     *            The array to write to the memory area.
     * @param off
