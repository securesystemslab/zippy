...
abstract class MemoryOp {
    ...
    public static final MemoryOp POINTER = new PointerOp(PointerCData.TYPE,
            CType.POINTER);
    ...
    public static final MemoryOp getMemoryOp(NativeType type) {
        ...
        case ULONGLONG:
            return UINT64;
        case LONG:
            return com.kenai.jffi.Platform.getPlatform().longSize() == 32 ? INT32
                    : INT64;
        case ULONG:
            return com.kenai.jffi.Platform.getPlatform().longSize() == 32 ? UINT32
                    : UINT64;
        case FLOAT:
            return FLOAT;
        case DOUBLE:
    ...
    static final class PointerOp extends MemoryOp {
        ...
        public final void put(Memory mem, long offset, PyObject value) {
            if (value instanceof Pointer) {
                mem.putAddress(offset, ((Pointer) value).getMemory()
                        .getAddress());
