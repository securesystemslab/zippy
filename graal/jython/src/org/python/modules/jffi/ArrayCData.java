...
public class ArrayCData extends CData implements Pointer {
    ...
    ArrayCData(PyType subtype, CType.Array arrayType, DirectMemory memory,
    ...
    @ExposedNew
    public static PyObject ArrayCData_new(PyNewWrapper new_, boolean init,
        ...
        DirectMemory memory = AllocatedNativeMemory.allocateAligned(
                arrayType.componentType.size() * arrayType.length,
        ...
        return new ArrayCData(subtype, arrayType, memory,
                arrayType.componentMemoryOp);
    }
    ...
    public static final PyObject from_address(PyType subtype, PyObject address) {
        ...
        PointerCData cdata = new PointerCData(subtype, arrayType,
                m.getMemory(0), arrayType.componentMemoryOp);
    ...
    protected final void initReferenceMemory(Memory m) {
        // Nothing to do, since the reference memory was initialized during
        // construction
    }
    ...
    protected final SequenceIndexDelegate delegator = new SequenceIndexDelegate() {
        ...
        public void setItem(int idx, PyObject value) {
            componentMemoryOp.put(getReferenceMemory(),
                    idx * componentType.size(), value);
        }
        ...
        public PyObject getItem(int idx) {
            return componentMemoryOp.get(getReferenceMemory(), idx
                    * componentType.size());
        }
    ...
    public class ArrayIter extends PyIterator {
        ...
        public PyObject __iternext__() {
            ...
            return componentMemoryOp.get(getReferenceMemory(), index++
                    * componentType.size());
        }
    }
