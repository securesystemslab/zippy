...
public class PyTableCode extends PyBaseCode {
    ...
    public PyTableCode(int argcount, String varnames[], String filename,
            String name, int firstlineno, boolean varargs, boolean varkwargs,
    ...
    public PyTableCode(int argcount, String varnames[], String filename,
            ...
            String[] freevars, int npurecell, int moreflags) // may change
    {
