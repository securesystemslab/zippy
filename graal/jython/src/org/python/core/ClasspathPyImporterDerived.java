...
public class ClasspathPyImporterDerived extends ClasspathPyImporter implements
        Slotted {
    ...
    public PyString __str__() {
        ...
        if (impl != null) {
            ...
            if (res instanceof PyString)
                return (PyString) res;
            throw Py.TypeError("__str__" + " returned non-" + "string"
                    + " (type " + res.getType().fastGetName() + ")");
        }
    ...
    public PyString __hex__() {
        ...
        if (impl != null) {
            ...
            if (res instanceof PyString)
                return (PyString) res;
            throw Py.TypeError("__hex__" + " returned non-" + "string"
                    + " (type " + res.getType().fastGetName() + ")");
        }
    ...
    public PyString __oct__() {
        ...
        if (impl != null) {
            ...
            if (res instanceof PyString)
                return (PyString) res;
            throw Py.TypeError("__oct__" + " returned non-" + "string"
                    + " (type " + res.getType().fastGetName() + ")");
        }
    ...
    public PyFloat __float__() {
        ...
        if (impl != null) {
            ...
            if (res instanceof PyFloat)
                return (PyFloat) res;
            throw Py.TypeError("__float__" + " returned non-" + "float"
                    + " (type " + res.getType().fastGetName() + ")");
        }
    ...
    public PyComplex __complex__() {
        ...
        if (impl != null) {
            ...
            throw Py.TypeError("__complex__" + " returned non-" + "complex"
                    + " (type " + res.getType().fastGetName() + ")");
        }
    ...
    public PyObject __long__() {
        ...
        if (impl != null) {
            ...
            if (res instanceof PyLong || res instanceof PyInteger)
                return res;
            throw Py.TypeError("__long__" + " returned non-" + "long"
                    + " (type " + res.getType().fastGetName() + ")");
        }
    ...
    public int __cmp__(PyObject other) {
        ...
        if (impl == null || where_type[0] == TYPE
                || Py.isSubClass(TYPE, where_type[0])) {
    ...
    public boolean __nonzero__() {
        ...
        if (c != PyInteger.class && c != PyBoolean.class) {
            throw Py.TypeError(String.format(
                    "__nonzero__ should return bool or int, returned %s",
                    self_type.getName()));
        }
    ...
    public PyObject __getitem__(PyObject key) {
        ...
        //
        // __getitem__ -> super.__getitem__ -> __finditem__ ->
        // super.__finditem__
    ...
    public PyObject __getslice__(PyObject start, PyObject stop, PyObject step) { // ???
        ...
        if (impl != null) {
            ...
            return impl.__get__(this, self_type).__call__(indices[0],
                    indices[1]);
        }
    ...
    public PyObject __index__() {
        ...
        if (impl != null) {
            ...
            throw Py.TypeError(String.format(
                    "__index__ returned non-(int,long) (type %s)", res
                            .getType().fastGetName()));
        }
    ...
    public Object __tojava__(Class c) {
        ...
        if (impl != null)
            return impl.__get__(this, self_type).__call__(Py.java2py(c))
