...
public abstract class PyBuiltinCallable extends PyObject {
    ...
    public String toString() {
        ...
        if (self == null) {
            ...
            return String.format("<built-in method %s of %s object at %s>",
                    info.getName(), self.getType().fastGetName(),
                    Py.idstr(self));
        }
    }
    ...
    public static class DefaultInfo implements Info {
        ...
        public static PyException unexpectedCall(int nargs, boolean keywords,
            ...
            if (minargs == maxargs) {
                ...
                return Py.TypeError(String.format(
                        "%s() requires at least %d arguments (%d) given", name,
                        minargs, nargs));
            } else if (minargs <= 0) {
            ...
            return Py.TypeError(String.format("%s() takes %s (%d given)", name,
                    argsblurb, nargs));
        }
