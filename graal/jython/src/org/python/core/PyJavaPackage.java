...
public class PyJavaPackage extends PyObject {
    ...
    /**
     * Its keys are the names of statically known classes. E.g. from jars
     * pre-scan.
     */
    ...
    public PyJavaPackage addPackage(String name, String jarfile) {
        ...
        if (p == null) {
            String pname = __name__.length() == 0 ? firstName : __name__ + '.'
                    + firstName;
     ...
     * uses {@link PackageManager#doDir} implementation furnished by the control
     * package manager with instantiate true. The package manager should load
     * classes with {@link #addClass} in the package.
     * 
