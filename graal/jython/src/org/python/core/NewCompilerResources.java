...
/**
 * This class contains stuff that almost exists in the library already, but with
 * interfaces that I found more suitable. If others agree this should be
 * migrated into the standard lib.
 * 
...
public class NewCompilerResources {
     ...
     * 
     * @param filter
     *            if true, if the name starts with an underscore '_' do not add
     *            it to locals
     * @param locals
