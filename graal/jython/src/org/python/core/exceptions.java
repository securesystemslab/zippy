...
public class exceptions extends PyObject implements ClassDictInit {
    ...
    public static void classDictInit(PyObject dict) {
        ...
        buildClass(dict, "KeyboardInterrupt", "BaseException",
        ...
        buildClass(dict, "IndentationError", "SyntaxError",
                "Improper indentation.");

        buildClass(dict, "TabError", "IndentationError",
        ...
        buildClass(dict, "OSError", "EnvironmentError",
                "OS system call failed.");

        buildClass(dict, "RuntimeError", "StandardError",
        ...
        buildClass(dict, "EOFError", "StandardError",
                "Read beyond end of file.");

        buildClass(dict, "ImportError", "StandardError",
                "Import can't find module, or can't find name in module.");

        buildClass(dict, "TypeError", "StandardError",
        ...
        buildClass(dict, "UnicodeEncodeError", "UnicodeError",
                UnicodeEncodeError(), "Unicode encoding error.");

        buildClass(dict, "UnicodeDecodeError", "UnicodeError",
                UnicodeDecodeError(), "Unicode decoding error.");

        buildClass(dict, "UnicodeTranslateError", "UnicodeError",
                UnicodeTranslateError(), "Unicode translation error.");

        buildClass(dict, "AssertionError", "StandardError", "Assertion failed.");

        buildClass(dict, "ArithmeticError", "StandardError",
        ...
        buildClass(dict, "LookupError", "StandardError",
                "Base class for lookup errors.");

        buildClass(dict, "IndexError", "LookupError",
                "Sequence index out of range.");

        buildClass(dict, "KeyError", "LookupError", KeyError(),
                "Mapping key not found.");

        buildClass(dict, "AttributeError", "StandardError",
                "Attribute not found.");

        buildClass(dict, "NameError", "StandardError",
        ...
        buildClass(dict, "GeneratorExit", "BaseException",
                "Request that a generator exit.");

        buildClass(dict, "Warning", "Exception",
    ...
    public static PyObject SyntaxError() {
        ...
        defineSlots(__dict__, "msg", "filename", "lineno", "offset", "text",
                "print_file_and_line");
        __dict__.__setitem__("__init__",
                bindStaticJavaMethod("__init__", "SyntaxError__init__"));
        __dict__.__setitem__("__str__",
                bindStaticJavaMethod("__str__", "SyntaxError__str__"));
        return __dict__;
    }

    public static void SyntaxError__init__(PyObject self, PyObject[] args,
            String[] kwargs) {
    ...
    public static PyString SyntaxError__str__(PyObject self, PyObject[] arg,
            String[] kwargs) {
        ...
        String result;
        if (haveFilename && haveLieno) {
            result = String.format("%s (%s, line %d)", str,
                    basename(filename.toString()), lineno.asInt());
    ...
    public static PyObject EnvironmentError() {
        ...
        dict.__setitem__("__init__",
                bindStaticJavaMethod("__init__", "EnvironmentError__init__"));
        dict.__setitem__("__str__",
                bindStaticJavaMethod("__str__", "EnvironmentError__str__"));
        dict.__setitem__(
                "__reduce__",
                bindStaticJavaMethod("__reduce__", "EnvironmentError__reduce__"));
        return dict;
    }

    public static void EnvironmentError__init__(PyObject self, PyObject[] args,
            String[] kwargs) {
        PyBaseException.TYPE.invoke("__init__", self, args, kwargs);
        initSlots(self);
    ...
    public static PyObject EnvironmentError__str__(PyObject self,
        ...
        if (filename.__nonzero__()) {
            result = String.format("[Errno %s] %s: %s", errno, strerror,
                    filename.__repr__());
    ...
    public static PyObject EnvironmentError__reduce__(PyObject self,
        ...
        // self->args is only the first two real arguments if there was a file
        // name given
        // to EnvironmentError
        if (selfBase.args.__len__() == 2 && filename != null) {
            reduceArgs = new PyTuple(selfBase.args.__finditem__(0),
                    selfBase.args.__finditem__(1), filename);
        }
    ...
    public static PyObject SystemExit() {
        ...
        dict.__setitem__("__init__",
                bindStaticJavaMethod("__init__", "SystemExit__init__"));
        return dict;
    }

    public static void SystemExit__init__(PyObject self, PyObject[] args,
            String[] kwargs) {
        PyBaseException.TYPE.invoke("__init__", self, args, kwargs);
        initSlots(self);
    ...
    public static PyObject KeyError() {
        PyObject dict = new PyStringMap();
        dict.__setitem__("__str__",
                bindStaticJavaMethod("__str__", "KeyError__str__"));
        return dict;
    }

    public static PyObject KeyError__str__(PyObject self, PyObject[] args,
            String[] kwargs) {
        PyBaseException selfBase = (PyBaseException) self;
    ...
    public static void UnicodeError__init__(PyObject self, PyObject[] args,
            String[] kwargs, PyType objectType) {
        ArgParser ap = new ArgParser("__init__", args, kwargs, new String[] {
                "encoding", "object", "start", "end", "reason" }, 5);
    ...
    public static PyObject UnicodeDecodeError() {
        PyObject dict = new PyStringMap();
        dict.__setitem__("__init__",
                bindStaticJavaMethod("__init__", "UnicodeDecodeError__init__"));
        dict.__setitem__("__str__",
                bindStaticJavaMethod("__str__", "UnicodeDecodeError__str__"));
        return dict;
    }
    ...
    public static PyString UnicodeDecodeError__str__(PyObject self,
        ...
        if (start < object.__len__() && end == (start + 1)) {
            ...
            result = String
                    .format("'%.400s' codec can't decode byte 0x%x in position %d: %.400s",
                            encoding, badByte, start, reason);
        } else {
            result = String
                    .format("'%.400s' codec can't decode bytes in position %d-%d: %.400s",
    ...
    public static PyObject UnicodeEncodeError() {
        PyObject dict = new PyStringMap();
        dict.__setitem__("__init__",
                bindStaticJavaMethod("__init__", "UnicodeEncodeError__init__"));
        dict.__setitem__("__str__",
                bindStaticJavaMethod("__str__", "UnicodeEncodeError__str__"));
        return dict;
    }
    ...
    public static PyString UnicodeEncodeError__str__(PyObject self,
        ...
        if (start < object.__len__() && end == (start + 1)) {
            ...
            result = String.format(
                    "'%.400s' codec can't encode character u'\\%s' in position %d: "
                            + "%.400s", encoding, badcharStr, start, reason);
        } else {
            result = String.format(
                    "'%.400s' codec can't encode characters in position %d-%d: "
    ...
    public static PyObject UnicodeTranslateError() {
        ...
        dict.__setitem__(
                "__init__",
                bindStaticJavaMethod("__init__",
                        "UnicodeTranslateError__init__"));
        dict.__setitem__("__str__",
                bindStaticJavaMethod("__str__", "UnicodeTranslateError__str__"));
        return dict;
    }
    ...
    public static PyString UnicodeTranslateError__str__(PyObject self,
        ...
        int start = self.__getattr__("start").asInt();
        int end = self.__getattr__("end").asInt();
        // Get reason as a string, which it might not be if it's been modified
        // after we
        // were contructed
        PyObject reason = self.__getattr__("reason").__str__();
        PyObject object = getUnicode(self.__getattr__("object"), "object");
    ...
    public static PyString getString(PyObject attr, String name) {
        if (!Py.isInstance(attr, PyString.TYPE)) {
            throw Py.TypeError(String.format("%.200s attribute must be str",
                    name));
        }
    ...
    private static PyObject buildClass(PyObject dict, String classname,
            String superclass, String doc) {
        return buildClass(dict, classname, superclass, new PyStringMap(), doc);
    }

    private static PyObject buildClass(PyObject dict, String classname,
            String superclass, PyObject classDict, String doc) {
    ...
    public static PyObject bindStaticJavaMethod(String name, Class<?> cls,
            String methodName) {
        Method javaMethod;
        try {
            javaMethod = cls.getMethod(methodName, new Class<?>[] {
                    PyObject.class, PyObject[].class, String[].class });
        } catch (Exception e) {
    ...
    static class BoundStaticJavaMethod extends PyBuiltinMethod {
        ...
        /**
         * The Java Method to be bound. Its signature must be: (PyObject,
        ...
        protected BoundStaticJavaMethod(PyType type, PyObject self, Info info,
                Method javaMethod) {
