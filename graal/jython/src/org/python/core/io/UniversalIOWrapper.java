...
public class UniversalIOWrapper extends TextIOBase {
    ...
    /**
     * Whether the next character, if it's an LF, should be skipped (the
     ...
     * 
     * Converts CR and CRLF to LF. No attempt is made to handle CRLF at EOF;
     * skipNextLF may be toggled true after this method returns.
     * 
     * @param src
