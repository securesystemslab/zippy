...
public class SyspathArchive extends PyString {
    ...
    InputStream getInputStream(ZipEntry entry) throws IOException {
        ...
        // -1 return value.
        // XXX: Since 1.1 is no longer supported, we should review the
        // usefulness
        // of this workaround.
    ...
    /*
     * protected void finalize() { System.out.println("closing zip file " +
     * toString()); try { zipFile.close(); } catch (IOException e) {
