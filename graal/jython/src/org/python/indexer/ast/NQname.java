...
public class NQname extends NNode {
    ...
    /**
     * Returns the next component of the chain, or {@code null} if this is the
     * last component.
     */
    ...
    /**
     * Returns {@code true} if this is the first/top component of the chain, or
     * if the name is unqualified (i.e. has only one component, no dots).
     */
    ...
    /**
     * Joins all components in this qname chain, beginning with the current
     * component.
     */
    ...
    /**
     * Returns the qname down to (and including) this component, ending with
     * this component's name. For instance, if this {@code NQname} instance
     * represents the {@code foo} in {@code org.foo.bar}, this method will
     * return {@code org.foo}.
     */
