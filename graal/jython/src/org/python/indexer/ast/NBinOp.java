...
public class NBinOp extends NNode {
    ...
    public NType resolve(Scope s) throws Exception {
        ...
        // If either non-null operand is a string, assume the result is a
        // string.
        if (ltype == Indexer.idx.builtins.BaseStr
                || rtype == Indexer.idx.builtins.BaseStr) {
            return setType(Indexer.idx.builtins.BaseStr);
        }
        // If either non-null operand is a number, assume the result is a
        // number.
        if (ltype == Indexer.idx.builtins.BaseNum
                || rtype == Indexer.idx.builtins.BaseNum) {
