...
public class NClassDef extends NNode {
    ...
    public NClassDef(NName name, List<NNode> bases, NBlock body, int start,
            int end) {
        super(start, end);
        this.name = name;
        this.bases = bases;
    ...
    public NType resolve(Scope s) throws Exception {
        ...
        addSpecialAttribute("__dict__", new NDictType(builtins.BaseStr,
                new NUnknownType()));
    ...
    private void addSpecialAttribute(String name, NType proptype) {
        NBinding b = getTable().update(name,
                Builtins.newTutUrl("classes.html"), proptype,
                NBinding.Kind.ATTRIBUTE);
        b.markSynthetic();
        b.markStatic();
        b.markReadOnly();
    }
