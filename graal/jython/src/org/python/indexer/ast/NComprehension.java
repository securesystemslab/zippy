...
public class NComprehension extends NNode {
    ...
    public NComprehension(NNode target, NNode iter, List<NNode> ifs, int start,
            int end) {
        super(start, end);
        this.target = target;
        this.iter = iter;
    ...
    private void bindNames(Scope s, NNode target, NameBinder binder)
            throws Exception {
    ...
    public String toString() {
        return "<Comprehension:" + start() + ":" + target + ":" + iter + ":"
                + ifs + ">";
    }
