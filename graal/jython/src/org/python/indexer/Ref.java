...
public class Ref {
    ...
    public Ref(NNode node) {
        ...
        if (node instanceof NName) {
            ...
            if (nn.isCall()) {
                ...
                // indexer will convert constructor-calls to NEW in a later
                // pass.
                markAsCall();
            }
            ...
            throw new IllegalArgumentException("I don't know what " + node
                    + " is.");
        }
     ...
     * @param offset
     *            the 0-indexed file offset of the reference
     * @param text
    ...
    /**
     * Returns {@code true} if this reference was an attribute of some other
     * node.
     */
    ...
    /**
     * Returns {@code true} if this reference was a quoted name. If so, the
     * {@link #start} and {@link #length} include the positions of the opening
     * and closing quotes, but {@link #isName} returns the text within the
     * quotes.
     */
