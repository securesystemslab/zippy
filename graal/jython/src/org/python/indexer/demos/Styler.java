...
class Styler extends DefaultNodeVisitor {
    ...
    static final Pattern BUILTIN = Pattern
            .compile("None|True|False|NotImplemented|Ellipsis|__debug__");

    /**
     * Matches the start of a triple-quote string.
     */
    private static final Pattern TRISTRING_PREFIX = Pattern
            .compile("^[ruRU]{0,2}['\"]{3}");
    ...
    private String sourceString(int beg, int end) {
        ...
        try {
            ...
            System.out.println("whoops: beg=" + a + ", end=" + b + ", len="
                    + source.length());
            return "";
        }
    }
