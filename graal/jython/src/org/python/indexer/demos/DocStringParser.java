...
class DocStringParser {
    ...
    /**
     * Only try to resolve possible qnames of at least this length. Helps cut
     * down on noise.
     */
    ...
    /**
     * Matches probable type names. Does loose matching; caller must do more
     * checks.
     */
    ...
    private Set<Integer> offsets = new HashSet<Integer>(); // styles we've
                                                           // already added
     ...
     * 
     * @param start
     *            beginning 0-based file offset of the doc string
     * @param comment
     ...
     * 
     * @param resolve
     *            {@code true} to do name resolution, {@code false} to guess
     *            purely based on syntax in the doc string. Pass {@code false}
     *            if you're using the highlighter to syntax-highlight a file
     *            (i.e. no code graph or indexing.)
     */
     ...
     * Main entry point.
     * 
     * @return the non-{@code null} but possibly empty list of additional styles
     *         for the doc string.
     */
    ...
    /**
     * Try to match potential type names against the code graph. If any match,
     * graph references and styles are added for them.
     */
    ...
    /**
     * Look for the name in the current scope. If found, and its qname is a
     * valid binding in the graph, record a reference.
     */
