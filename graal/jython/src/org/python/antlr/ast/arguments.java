...
public class arguments extends PythonTree {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("args"), new PyString("vararg"),
            new PyString("kwarg"), new PyString("defaults") };
    ...
    public arguments(PyObject args, PyObject vararg, PyObject kwarg,
            PyObject defaults) {
        setArgs(args);
        setVararg(vararg);
        setKwarg(kwarg);
    ...
    // public arguments(Token token, java.util.List<expr> args, String vararg,
    // String kwarg,
    ...
    public arguments(Token token, java.util.List<expr> args, Name vararg,
            Name kwarg, java.util.List<expr> defaults) {
        super(token);
        this.args = args;
        if (args == null) {
            this.args = new ArrayList<expr>();
    ...
    public arguments(Integer ttype, Token token, java.util.List<expr> args,
            String vararg, String kwarg, java.util.List<expr> defaults) {
        super(ttype, token);
        this.args = args;
        if (args == null) {
            this.args = new ArrayList<expr>();
    ...
    public arguments(PythonTree tree, java.util.List<expr> args, String vararg,
            String kwarg, java.util.List<expr> defaults) {
        super(tree);
        this.args = args;
        if (args == null) {
            this.args = new ArrayList<expr>();
...
//            for (PythonTree t : defaults) {
    ...
    public Object execute(VirtualFrame frame) {
        List<PyObject> defaultArguments = new ArrayList<PyObject>();

        for (expr e : defaults) {
            Object value = e.executeGeneric(frame);
            if (value instanceof PyObject) {
                defaultArguments.add((PyObject) value);
            } else if (value instanceof CallTarget) {
                PyObject packed = PyObjectContainer.pack(value);
                defaultArguments.add(packed);
            }
        }

        return new PyTuple(defaultArguments.toArray(new PyObject[defaultArguments.size()]));
    }
