...
public class UnaryOp extends expr {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("op"), new PyString("operand") };
    ...
    public Object executeGeneric(VirtualFrame frame) {
        PyObject operandValue = (PyObject) operand.executeGeneric(frame);
        PyObject result;
        
        switch(op) {
        case Invert:
            result = operandValue.__invert__();
            break;
        case Not:
            result = operandValue.__not__();
            break;
        case UAdd:
            throw Py.SystemError("What does UAdd mean?");
        case USub:
            result = operandValue.__neg__();
            break;
        default:
            throw Py.SystemError("Should not be reachable");
        }
