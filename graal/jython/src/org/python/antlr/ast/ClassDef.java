...
public class ClassDef extends stmt {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("name"), new PyString("bases"), new PyString("body"),
    ...
    public void ClassDef___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("ClassDef", args, keywords, new String[] {
                "name", "bases", "body", "decorator_list", "lineno",
                "col_offset" }, 4, true);
    ...
    public ClassDef(PyObject name, PyObject bases, PyObject body,
    ...
    public ClassDef(Token token, String name, java.util.List<expr> bases,
    ...
    public ClassDef(Integer ttype, Token token, String name,
            java.util.List<expr> bases, java.util.List<stmt> body,
