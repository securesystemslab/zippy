...
@ExposedType(name = "_ast.While", base = AST.class)
public class While extends stmt {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("test"), new PyString("body"), new PyString("orelse") };
    ...
    public While(Token token, expr test, java.util.List<stmt> body,
    ...
    public While(Integer ttype, Token token, expr test,
    ...
    public While(PythonTree tree, expr test, java.util.List<stmt> body,
            java.util.List<stmt> orelse) {
        super(tree);
        this.test = test;
        addChild(test);
    ...
    public void traverse(VisitorIF<?> visitor) throws Exception {
        if (test != null)
            test.accept(visitor);
        if (body != null) {
            // Modified due to java.util.ConcurrentModificationException
...
//            for (PythonTree t : orelse) {
    ...
    public void executeVoid(VirtualFrame frame) {
        try {
            while (((PyObject) test.executeGeneric(frame)).__nonzero__()) {
                try {
