...
public class ExceptHandler extends excepthandler {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("type"), new PyString("name"), new PyString("body") };
    ...
    public void ExceptHandler___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser(
                ...
                args,
                keywords,
                new String[] { "type", "name", "body", "lineno", "col_offset" },
                3, true);
    ...
    public ExceptHandler(Token token, expr type, expr name,
    ...
    public ExceptHandler(Integer ttype, Token token, expr type, expr name,
            java.util.List<stmt> body) {
        super(ttype, token);
        this.type = type;
        addChild(type);
    ...
    public ExceptHandler(PythonTree tree, expr type, expr name,
            java.util.List<stmt> body) {
        super(tree);
        this.type = type;
        addChild(type);
