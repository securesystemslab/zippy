...
public class DictComp extends expr {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("key"), new PyString("value"),
            new PyString("generators") };
    ...
    public DictComp(Token token, expr key, expr value,
    ...
    public DictComp(Integer ttype, Token token, expr key, expr value,
            java.util.List<comprehension> generators) {
        super(ttype, token);
        this.key = key;
        addChild(key);
    ...
    public DictComp(PythonTree tree, expr key, expr value,
            java.util.List<comprehension> generators) {
        super(tree);
        this.key = key;
        addChild(key);
