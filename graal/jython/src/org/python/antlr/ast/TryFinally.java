...
public class TryFinally extends stmt {
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("body"), new PyString("finalbody") };
    ...
    public void TryFinally___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("TryFinally", args, keywords,
                new String[] { "body", "finalbody", "lineno", "col_offset" },
                2, true);
    ...
    public TryFinally(Token token, java.util.List<stmt> body,
            java.util.List<stmt> finalbody) {
        super(token);
        this.body = body;
        if (body == null) {
    ...
    public TryFinally(Integer ttype, Token token, java.util.List<stmt> body,
            java.util.List<stmt> finalbody) {
        super(ttype, token);
        this.body = body;
        if (body == null) {
    ...
    public TryFinally(PythonTree tree, java.util.List<stmt> body,
            java.util.List<stmt> finalbody) {
        super(tree);
        this.body = body;
        if (body == null) {
