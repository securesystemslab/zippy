...
public class List extends expr implements Context {
    ...
    public List(Integer ttype, Token token, java.util.List<expr> elts,
    ...
    public void traverse(VisitorIF<?> visitor) throws Exception {
        if (elts != null) {
            // Modified duet to ConcurrentModificationException
//            for (PythonTree t : elts) {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ArrayList<PyObject> elements = new ArrayList<PyObject>();

        for (expr e : elts) {
            elements.add((PyObject) e.executeGeneric(frame));
        }

        return new PyList(elements.toArray(new PyObject[elements.size()]));
    }
