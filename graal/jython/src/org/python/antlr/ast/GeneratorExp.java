...
public class GeneratorExp extends expr {
    ...
    public void setFrameDescriptor(FrameDescriptor frameDescriptor) {
        ...
        if (ASTInterpreter.debug) {
            System.out.println("----> frameDescriptor " + this + " " + frameDescriptor.getSlots());
        }
    }
    ...
    private final static PyString[] fields = new PyString[] {
            new PyString("elt"), new PyString("generators") };
    ...
    public void GeneratorExp___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("GeneratorExp", args, keywords,
                new String[] { "elt", "generators", "lineno", "col_offset" },
                2, true);
    ...
    public GeneratorExp(Token token, expr elt,
            java.util.List<comprehension> generators) {
        super(token);
        this.elt = elt;
        addChild(elt);
    ...
    public GeneratorExp(Integer ttype, Token token, expr elt,
            java.util.List<comprehension> generators) {
        super(ttype, token);
        this.elt = elt;
        addChild(elt);
    ...
    public GeneratorExp(PythonTree tree, expr elt,
            java.util.List<comprehension> generators) {
        super(tree);
        this.elt = elt;
        addChild(elt);
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        // evaluate first iterator
        Object iterator = generators.get(0).getIterator(frame);
        GeneratorCallTarget gct = new GeneratorCallTarget(generators.get(0), frameDescriptor, iterator);
        
        PythonTree parent = (PythonTree) getParent();
        if (parent instanceof Assign) {
            return gct;
        } else {
            return gct.call(frame.pack(), new PArguments());
        }
    }
