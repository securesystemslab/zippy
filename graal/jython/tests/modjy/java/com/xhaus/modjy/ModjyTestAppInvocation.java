...
public class ModjyTestAppInvocation extends ModjyTestBase {
    ...
    String[] importablepathElements = new String[] { "mock_framework", "web",
            "handlers", "wsgi_handlers", };
