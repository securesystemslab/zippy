...
public class DataHandlerTest extends TestCase {
    ...
    public void testGetPyObjectResultSetIntInt() throws Exception {
        ResultSet rs = (ResultSet) Proxy.newProxyInstance(getClass()
                .getClassLoader(), new Class<?>[] { ResultSet.class },
                new DefaultReturnHandler());
        List<String> unsupportedTypes = Arrays.asList("ARRAY", "DATALINK",
                "DISTINCT", "REF", "ROWID", // java 6
                "STRUCT");
        for (Field field : Types.class.getDeclaredFields()) {
            ...
            if (unsupportedTypes.contains(typeName)) {
                ...
                assertNotNull(typeName + " should return None",
                        _handler.getPyObject(rs, 1, type));
            }
        }
    }
    ...
    /**
     * This is a poor man's mock - i cannot introduce a mock framework at this
     * point in time
     */
    static class DefaultReturnHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args)
            ...
            if (returnType.equals(Boolean.class)
                ...
                throw new RuntimeException("unhandled primitve type "
                        + returnType);
