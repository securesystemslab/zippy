...
public class InterpreterTest extends TestCase {
    ...
    public void testMultipleThreads() {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    assertEquals("hello goodbye",
                            Py.tojava(interp.get("x"), String.class));
        ...
        try {
            ...
            System.err
                    .println("Interpreters in multiple threads test interrupted, bailing");
        }
    }
    ...
    public void testCallInstancesFromJava() {
        ...
        for (int i = 0; i < 4; i++) {
            assertEquals(++base,
                    blahInstance.invoke("incval").__tojava__(Integer.class));
        }
    }
}
