...
public class CustomizableMapHolder {
    ...
    public static void clearAdditions() {
        PyObject dict = PyType.fromClass(CustomizableMapHolder.class)
                .fastGetDict();
        for (String name : new String[] { "__getitem__", "__setitem__",
                "__getattribute__" }) {
    ...
    public static void addGetitem() {
        PyBuiltinMethod meth = new PyBuiltinMethodNarrow("__getitem__", 1) {
            ...
            public PyObject __call__(PyObject arg) {
                CustomizableMapHolder inst = Py.tojava(self,
                        CustomizableMapHolder.class);
    ...
    public static void addGetattribute() {
        final PyObject objectGetattribute = PyObject.TYPE
