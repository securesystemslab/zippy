...
public class SubVisible extends Visible implements VisibleOverride {
    ...
    /**
     * Ensure that overridden methods on subclasses are picked up properly.
     * Overrides {@link Visible#visibleInstance(int)}
     */
    @Override
    ...
    /**
     * Ensure that overloading {@link Visible#visibleInstance(int, String)} gets
     * mapped correctly
     */
