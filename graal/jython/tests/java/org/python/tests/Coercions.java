...
/**
 * Called in various forms by test_java_visibility.CoercionsTest to see if
 * Python wrapped Java types are unwrapped to the correct call.
 */
public class Coercions {
    ...
    // Not really an array, but we want to make sure Python code doesn't pick up
    // on it
    // inappropriately.
    public static String takeArray(Object obj) {
        return "Object";
