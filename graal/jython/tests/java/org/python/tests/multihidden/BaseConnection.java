...
/**
 * Derived from the Oracle JDBC connection classes for use in
 * test_extending_multiple_hidden_classes in test_java_visibility.
 */
...
class ConnectionWrapper extends BaseConnection {
    ...
    // This method, plus the fact that Connection implements an interface with a
    // different
