...
public class TypeExposerTest extends InterpTestCase {
    ...
    public void testMakeBuilder() throws Exception {
        ExposedTypeProcessor etp = new ExposedTypeProcessor(getClass()
    ...
    public void testGoodNew() throws IOException {
        ExposedTypeProcessor etp = new ExposedTypeProcessor(
                getClass()
                        .getClassLoader()
                        .getResourceAsStream(
                                "org/python/expose/generate/TypeExposerTest$SimplestNew.class"));
        ...
        PyNewWrapper new_ = (PyNewWrapper) te.getDict(simplestType)
                .__finditem__("__new__");
        assertEquals(Py.One, new_.new_impl(false, null, null, null));
    }

    public void testCatchingDupes() throws IOException {
        try {
            new ExposedTypeProcessor(
                    getClass()
                            .getClassLoader()
                            .getResourceAsStream(
                                    "org/python/expose/generate/TypeExposerTest$DupeMethodNames.class"));
    ...
    public class NonstaticNew {
        ...
        @ExposedNew
        public PyObject __new__(PyNewWrapper new_, boolean init,
    ...
    public static class SimplestNew {
        ...
        @ExposedNew
        public static PyObject __new__(PyNewWrapper new_, boolean init,
                PyType subtype, PyObject[] args, String[] keywords) {
            return Py.One;
        }
    }
