...
public class PySystemStateTest extends TestCase {
    ...
    public void testGetJarFileNameFromURL_jboss() throws Exception {
        ...
        if (Platform.IS_WINDOWS) {
            ...
            assertEquals(
                    "vfszip:/C:/some_dir/some.jar/org/python/core/PySystemState.class",
                    url.toString());
            assertEquals("C:/some_dir/some.jar",
                    PySystemState.getJarFileNameFromURL(url));
            // jboss url to decode
            file = "/C:/some%20dir/some.jar/org/python/core/PySystemState.class";
            url = new URL(protocol, host, port, file, handler);
            assertEquals(
                    "vfszip:/C:/some%20dir/some.jar/org/python/core/PySystemState.class",
                    url.toString());
            assertEquals("C:/some dir/some.jar",
                    PySystemState.getJarFileNameFromURL(url));
            // jboss url with + to escape
            file = "/C:/some+dir/some.jar/org/python/core/PySystemState.class";
            url = new URL(protocol, host, port, file, handler);
            assertEquals(
                    "vfszip:/C:/some+dir/some.jar/org/python/core/PySystemState.class",
                    url.toString());
            assertEquals("C:/some+dir/some.jar",
                    PySystemState.getJarFileNameFromURL(url));
        } else {
            ...
            url = new URL(protocol, host, port, file, handler);
            assertEquals(
                    "vfszip:/some_dir/some.jar/org/python/core/PySystemState.class",
                    url.toString());
            assertEquals("/some_dir/some.jar",
                    PySystemState.getJarFileNameFromURL(url));
            // jboss url to decode
            ...
            url = new URL(protocol, host, port, file, handler);
            assertEquals(
                    "vfszip:/some%20dir/some.jar/org/python/core/PySystemState.class",
                    url.toString());
            assertEquals("/some dir/some.jar",
                    PySystemState.getJarFileNameFromURL(url));
            // jboss url with + to escape
            ...
            url = new URL(protocol, host, port, file, handler);
            assertEquals(
                    "vfszip:/some+dir/some.jar/org/python/core/PySystemState.class",
                    url.toString());
            assertEquals("/some+dir/some.jar",
                    PySystemState.getJarFileNameFromURL(url));
        }
    ...
    protected static class TestJBossURLStreamHandler extends URLStreamHandler {
        ...
        protected URLConnection openConnection(URL u) throws IOException {
            throw new RuntimeException("unexpected call to openConnection "
                    + u.toString());
        }
    }
}
