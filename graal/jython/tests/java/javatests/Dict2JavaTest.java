...
/**
 * This class is used by the test_dict2java.py test script for testing the
 * org.python.core.PyDictionary object's java.util.Map. We verifiy that the Map
 * interface can be seamlessly passed to java code and manipulated in a
 * consistent manner.
 */
public class Dict2JavaTest {
    ...
    public boolean test_entry_set_nulls() {
        ...
        return set.contains(null) == false && set.remove(null) == false
                && set.contains(new Boolean(true)) == false
                && set.remove(new String("")) == false;
    }
