...
public abstract class ListTest {
    ...
    public void test_get() {
        ...
        try {
            l.get(-1);
            TestSupport
                    .fail("get(<negative index>) did not throw IndexOutOfBoundsException");
        } catch (IndexOutOfBoundsException e) {
        }
        try {
            l.get(l.size());
            TestSupport
                    .fail("get(<index too big>) did not throw IndexOutOfBoundsException");
        } catch (IndexOutOfBoundsException e) {
        }
    }
    ...
    public void test_set() {
        ...
        try {
            ...
            TestSupport
                    .fail("set(<index too big>) did not throw IndexOutOfBoundsException");
        } catch (IndexOutOfBoundsException e) {
        }
    ...
    public void test_indexOf() {
        TestSupport.assertThat(defaultList().indexOf(3) == 3,
    ...
    public void test_remove_index() {
        ...
        try {
            a.remove(0);
            TestSupport
                    .fail("removing a non-existing index did not throw exception");
        } catch (IndexOutOfBoundsException e) {
        }
    }
    ...
    public void test_lastIndexOf() {
        ...
        TestSupport.assertThat(a.lastIndexOf(0) == 4,
    ...
    public void test_removeAll() {
        ...
        TestSupport.assertThat(yanl.removeAll(nullList) == true,
                "mutating removeAll() did not return true");
        TestSupport
                .assertThat(yanl.size() == 0, "empty list had non-zero size");
    ...
    public void test_hashCode() {
        ...
        if (isReadOnly() == false) {
            ...
            b.remove(0);
            TestSupport
                    .assertThat(a.hashCode() != b.hashCode(),
                            "Instances with different internal state have the same hashcode");
        }
    }
    ...
    public void test_containsAll() {
        ...
        TestSupport.assertThat(
                newInstance(null).containsAll(defaultList()) == false,
                "containsAll(<disjoint List>) returned true");
        TestSupport.assertThat(
                defaultList().containsAll(defaultList().subList(1, 3)),
    ...
    public void test_iterator() {
        ...
        for (Object element : a) {
            TestSupport.assertThat(element == a.get(i++),
    ...
    public void test_listIterator() {
        ...
        TestSupport.assertThat(!li.hasNext(),
        ...
        while (!isReadOnly() && li.hasNext()) {
            ...
            li.set(42);
            TestSupport
                    .assertThat(li.previous().equals(42),
    ...
    public void test_toArray() {
        ...
        TestSupport.assertThat(
                Arrays.equals(defaultList().toArray(), intObjArray),
    ...
    public void test_toArray_typed() {
        ...
        TestSupport
                .assertThat(Arrays.equals(
                        defaultList().toArray(new Integer[0]), intObjArray),
